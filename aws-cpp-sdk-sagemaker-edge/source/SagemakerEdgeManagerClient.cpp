...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SagemakerEdgeManagerClient::GetDeployments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SagemakerEdgeManagerClient::GetDeployments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SagemakerEdgeManagerClient::GetDeviceRegistration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SagemakerEdgeManagerClient::GetDeviceRegistration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SagemakerEdgeManagerClient::SendHeartbeat, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SagemakerEdgeManagerClient::SendHeartbeat, this, request, handler, context, m_executor.get());
}
