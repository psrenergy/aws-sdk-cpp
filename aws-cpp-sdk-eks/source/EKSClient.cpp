...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::AssociateEncryptionConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::AssociateEncryptionConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::AssociateIdentityProviderConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::AssociateIdentityProviderConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::CreateAddon, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::CreateAddon, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::CreateCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::CreateCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::CreateFargateProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::CreateFargateProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::CreateNodegroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::CreateNodegroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DeleteAddon, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DeleteAddon, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DeleteCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DeleteCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DeleteFargateProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DeleteFargateProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DeleteNodegroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DeleteNodegroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DeregisterCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DeregisterCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DescribeAddon, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DescribeAddon, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DescribeAddonVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DescribeAddonVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DescribeCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DescribeCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DescribeFargateProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DescribeFargateProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DescribeIdentityProviderConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DescribeIdentityProviderConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DescribeNodegroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DescribeNodegroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DescribeUpdate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DescribeUpdate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::DisassociateIdentityProviderConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::DisassociateIdentityProviderConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::ListAddons, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::ListAddons, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::ListClusters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::ListClusters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::ListFargateProfiles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::ListFargateProfiles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::ListIdentityProviderConfigs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::ListIdentityProviderConfigs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::ListNodegroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::ListNodegroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::ListUpdates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::ListUpdates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::RegisterCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::RegisterCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::UpdateAddon, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::UpdateAddon, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::UpdateClusterConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::UpdateClusterConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::UpdateClusterVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::UpdateClusterVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::UpdateNodegroupConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::UpdateNodegroupConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EKSClient::UpdateNodegroupVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EKSClient::UpdateNodegroupVersion, this, request, handler, context, m_executor.get());
}
