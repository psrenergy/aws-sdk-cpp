...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::CreateCell, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::CreateCell, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::CreateCrossAccountAuthorization, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::CreateCrossAccountAuthorization, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::CreateReadinessCheck, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::CreateReadinessCheck, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::CreateRecoveryGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::CreateRecoveryGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::CreateResourceSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::CreateResourceSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::DeleteCell, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::DeleteCell, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::DeleteCrossAccountAuthorization, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::DeleteCrossAccountAuthorization, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::DeleteReadinessCheck, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::DeleteReadinessCheck, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::DeleteRecoveryGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::DeleteRecoveryGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::DeleteResourceSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::DeleteResourceSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::GetArchitectureRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::GetArchitectureRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::GetCell, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::GetCell, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::GetCellReadinessSummary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::GetCellReadinessSummary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::GetReadinessCheck, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::GetReadinessCheck, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::GetReadinessCheckResourceStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::GetReadinessCheckResourceStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::GetReadinessCheckStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::GetReadinessCheckStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::GetRecoveryGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::GetRecoveryGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::GetRecoveryGroupReadinessSummary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::GetRecoveryGroupReadinessSummary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::GetResourceSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::GetResourceSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::ListCells, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::ListCells, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::ListCrossAccountAuthorizations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::ListCrossAccountAuthorizations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::ListReadinessChecks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::ListReadinessChecks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::ListRecoveryGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::ListRecoveryGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::ListResourceSets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::ListResourceSets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::ListRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::ListRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::ListTagsForResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::ListTagsForResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::UpdateCell, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::UpdateCell, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::UpdateReadinessCheck, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::UpdateReadinessCheck, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::UpdateRecoveryGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::UpdateRecoveryGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53RecoveryReadinessClient::UpdateResourceSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53RecoveryReadinessClient::UpdateResourceSet, this, request, handler, context, m_executor.get());
}
