...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTFleetHubClient::CreateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTFleetHubClient::CreateApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTFleetHubClient::DeleteApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTFleetHubClient::DeleteApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTFleetHubClient::DescribeApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTFleetHubClient::DescribeApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTFleetHubClient::ListApplications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTFleetHubClient::ListApplications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTFleetHubClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTFleetHubClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTFleetHubClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTFleetHubClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTFleetHubClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTFleetHubClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTFleetHubClient::UpdateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTFleetHubClient::UpdateApplication, this, request, handler, context, m_executor.get());
}
