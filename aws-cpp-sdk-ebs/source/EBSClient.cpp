...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EBSClient::CompleteSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EBSClient::CompleteSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EBSClient::GetSnapshotBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EBSClient::GetSnapshotBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EBSClient::ListChangedBlocks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EBSClient::ListChangedBlocks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EBSClient::ListSnapshotBlocks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EBSClient::ListSnapshotBlocks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EBSClient::PutSnapshotBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EBSClient::PutSnapshotBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EBSClient::StartSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EBSClient::StartSnapshot, this, request, handler, context, m_executor.get());
}
