...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::AddNotificationChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::AddNotificationChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DeleteInsight, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DeleteInsight, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeAccountHealth, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeAccountHealth, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeAccountOverview, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeAccountOverview, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeAnomaly, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeAnomaly, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeEventSourcesConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeEventSourcesConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeFeedback, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeFeedback, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeInsight, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeInsight, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeOrganizationHealth, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeOrganizationHealth, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeOrganizationOverview, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeOrganizationOverview, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeOrganizationResourceCollectionHealth, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeOrganizationResourceCollectionHealth, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeResourceCollectionHealth, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeResourceCollectionHealth, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::DescribeServiceIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::DescribeServiceIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::GetCostEstimation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::GetCostEstimation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::GetResourceCollection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::GetResourceCollection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::ListAnomaliesForInsight, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::ListAnomaliesForInsight, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::ListAnomalousLogGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::ListAnomalousLogGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::ListEvents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::ListEvents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::ListInsights, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::ListInsights, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::ListMonitoredResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::ListMonitoredResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::ListNotificationChannels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::ListNotificationChannels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::ListOrganizationInsights, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::ListOrganizationInsights, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::ListRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::ListRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::PutFeedback, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::PutFeedback, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::RemoveNotificationChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::RemoveNotificationChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::SearchInsights, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::SearchInsights, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::SearchOrganizationInsights, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::SearchOrganizationInsights, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::StartCostEstimation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::StartCostEstimation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::UpdateEventSourcesConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::UpdateEventSourcesConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::UpdateResourceCollection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::UpdateResourceCollection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DevOpsGuruClient::UpdateServiceIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DevOpsGuruClient::UpdateServiceIntegration, this, request, handler, context, m_executor.get());
}
