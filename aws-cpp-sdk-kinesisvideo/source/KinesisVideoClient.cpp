...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::CreateSignalingChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::CreateSignalingChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::CreateStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::CreateStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::DeleteSignalingChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::DeleteSignalingChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::DeleteStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::DeleteStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::DescribeImageGenerationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::DescribeImageGenerationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::DescribeNotificationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::DescribeNotificationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::DescribeSignalingChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::DescribeSignalingChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::DescribeStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::DescribeStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::GetDataEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::GetDataEndpoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::GetSignalingChannelEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::GetSignalingChannelEndpoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::ListSignalingChannels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::ListSignalingChannels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::ListStreams, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::ListStreams, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::ListTagsForStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::ListTagsForStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::TagStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::TagStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::UntagStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::UntagStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::UpdateDataRetention, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::UpdateDataRetention, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::UpdateImageGenerationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::UpdateImageGenerationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::UpdateNotificationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::UpdateNotificationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::UpdateSignalingChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::UpdateSignalingChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoClient::UpdateStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoClient::UpdateStream, this, request, handler, context, m_executor.get());
}
