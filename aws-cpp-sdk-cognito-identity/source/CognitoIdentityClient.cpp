...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::CreateIdentityPool, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::CreateIdentityPool, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::DeleteIdentities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::DeleteIdentities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::DeleteIdentityPool, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::DeleteIdentityPool, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::DescribeIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::DescribeIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::DescribeIdentityPool, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::DescribeIdentityPool, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::GetCredentialsForIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::GetCredentialsForIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::GetId, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::GetId, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::GetIdentityPoolRoles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::GetIdentityPoolRoles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::GetOpenIdToken, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::GetOpenIdToken, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::GetOpenIdTokenForDeveloperIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::GetOpenIdTokenForDeveloperIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::GetPrincipalTagAttributeMap, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::GetPrincipalTagAttributeMap, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::ListIdentities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::ListIdentities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::ListIdentityPools, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::ListIdentityPools, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::LookupDeveloperIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::LookupDeveloperIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::MergeDeveloperIdentities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::MergeDeveloperIdentities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::SetIdentityPoolRoles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::SetIdentityPoolRoles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::SetPrincipalTagAttributeMap, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::SetPrincipalTagAttributeMap, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::UnlinkDeveloperIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::UnlinkDeveloperIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::UnlinkIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::UnlinkIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CognitoIdentityClient::UpdateIdentityPool, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CognitoIdentityClient::UpdateIdentityPool, this, request, handler, context, m_executor.get());
}
