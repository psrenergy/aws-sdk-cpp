...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::CreateParallelData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::CreateParallelData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::DeleteParallelData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::DeleteParallelData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::DeleteTerminology, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::DeleteTerminology, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::DescribeTextTranslationJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::DescribeTextTranslationJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::GetParallelData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::GetParallelData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::GetTerminology, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::GetTerminology, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::ImportTerminology, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::ImportTerminology, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::ListLanguages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::ListLanguages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::ListParallelData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::ListParallelData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::ListTerminologies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::ListTerminologies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::ListTextTranslationJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::ListTextTranslationJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::StartTextTranslationJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::StartTextTranslationJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::StopTextTranslationJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::StopTextTranslationJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::TranslateText, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::TranslateText, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranslateClient::UpdateParallelData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranslateClient::UpdateParallelData, this, request, handler, context, m_executor.get());
}
