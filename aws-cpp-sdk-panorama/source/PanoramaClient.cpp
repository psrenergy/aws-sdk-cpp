...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::CreateApplicationInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::CreateApplicationInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::CreateJobForDevices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::CreateJobForDevices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::CreateNodeFromTemplateJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::CreateNodeFromTemplateJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::CreatePackage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::CreatePackage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::CreatePackageImportJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::CreatePackageImportJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DeleteDevice, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DeleteDevice, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DeletePackage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DeletePackage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DeregisterPackageVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DeregisterPackageVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DescribeApplicationInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DescribeApplicationInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DescribeApplicationInstanceDetails, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DescribeApplicationInstanceDetails, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DescribeDevice, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DescribeDevice, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DescribeDeviceJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DescribeDeviceJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DescribeNode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DescribeNode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DescribeNodeFromTemplateJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DescribeNodeFromTemplateJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DescribePackage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DescribePackage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DescribePackageImportJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DescribePackageImportJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::DescribePackageVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::DescribePackageVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListApplicationInstanceDependencies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListApplicationInstanceDependencies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListApplicationInstanceNodeInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListApplicationInstanceNodeInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListApplicationInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListApplicationInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListDevices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListDevices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListDevicesJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListDevicesJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListNodeFromTemplateJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListNodeFromTemplateJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListNodes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListNodes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListPackageImportJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListPackageImportJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListPackages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListPackages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::ProvisionDevice, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::ProvisionDevice, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::RegisterPackageVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::RegisterPackageVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::RemoveApplicationInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::RemoveApplicationInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::SignalApplicationInstanceNodeInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::SignalApplicationInstanceNodeInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PanoramaClient::UpdateDeviceMetadata, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PanoramaClient::UpdateDeviceMetadata, this, request, handler, context, m_executor.get());
}
