...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::AddProfilePermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::AddProfilePermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::CancelSigningProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::CancelSigningProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::DescribeSigningJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::DescribeSigningJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::GetSigningPlatform, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::GetSigningPlatform, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::GetSigningProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::GetSigningProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::ListProfilePermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::ListProfilePermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::ListSigningJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::ListSigningJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::ListSigningPlatforms, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::ListSigningPlatforms, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::ListSigningProfiles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::ListSigningProfiles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::PutSigningProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::PutSigningProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::RemoveProfilePermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::RemoveProfilePermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::RevokeSignature, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::RevokeSignature, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::RevokeSigningProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::RevokeSigningProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::StartSigningJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::StartSigningJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SignerClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SignerClient::UntagResource, this, request, handler, context, m_executor.get());
}
