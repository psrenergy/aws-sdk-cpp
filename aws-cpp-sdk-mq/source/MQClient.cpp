...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::CreateBroker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::CreateBroker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::CreateConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::CreateConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::CreateTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::CreateTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::CreateUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::CreateUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::DeleteBroker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::DeleteBroker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::DeleteTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::DeleteTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::DeleteUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::DeleteUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::DescribeBroker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::DescribeBroker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::DescribeBrokerEngineTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::DescribeBrokerEngineTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::DescribeBrokerInstanceOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::DescribeBrokerInstanceOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::DescribeConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::DescribeConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::DescribeConfigurationRevision, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::DescribeConfigurationRevision, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::DescribeUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::DescribeUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::ListBrokers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::ListBrokers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::ListConfigurationRevisions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::ListConfigurationRevisions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::ListConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::ListConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::ListTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::ListTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::ListUsers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::ListUsers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::RebootBroker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::RebootBroker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::UpdateBroker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::UpdateBroker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::UpdateConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::UpdateConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MQClient::UpdateUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MQClient::UpdateUser, this, request, handler, context, m_executor.get());
}
