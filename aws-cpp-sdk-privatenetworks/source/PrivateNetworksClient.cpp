...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::AcknowledgeOrderReceipt, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::AcknowledgeOrderReceipt, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::ActivateDeviceIdentifier, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::ActivateDeviceIdentifier, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::ActivateNetworkSite, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::ActivateNetworkSite, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::ConfigureAccessPoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::ConfigureAccessPoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::CreateNetwork, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::CreateNetwork, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::CreateNetworkSite, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::CreateNetworkSite, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::DeactivateDeviceIdentifier, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::DeactivateDeviceIdentifier, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::DeleteNetwork, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::DeleteNetwork, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::DeleteNetworkSite, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::DeleteNetworkSite, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::GetDeviceIdentifier, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::GetDeviceIdentifier, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::GetNetwork, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::GetNetwork, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::GetNetworkResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::GetNetworkResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::GetNetworkSite, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::GetNetworkSite, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::GetOrder, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::GetOrder, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::ListDeviceIdentifiers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::ListDeviceIdentifiers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::ListNetworkResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::ListNetworkResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::ListNetworkSites, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::ListNetworkSites, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::ListNetworks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::ListNetworks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::ListOrders, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::ListOrders, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::UpdateNetworkSite, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::UpdateNetworkSite, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PrivateNetworksClient::UpdateNetworkSitePlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PrivateNetworksClient::UpdateNetworkSitePlan, this, request, handler, context, m_executor.get());
}
