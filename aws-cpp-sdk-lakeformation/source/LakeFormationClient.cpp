...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::AddLFTagsToResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::AddLFTagsToResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::AssumeDecoratedRoleWithSAML, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::AssumeDecoratedRoleWithSAML, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::BatchGrantPermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::BatchGrantPermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::BatchRevokePermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::BatchRevokePermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::CancelTransaction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::CancelTransaction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::CommitTransaction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::CommitTransaction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::CreateDataCellsFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::CreateDataCellsFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::CreateLFTag, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::CreateLFTag, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::DeleteDataCellsFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::DeleteDataCellsFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::DeleteLFTag, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::DeleteLFTag, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::DeleteObjectsOnCancel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::DeleteObjectsOnCancel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::DeregisterResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::DeregisterResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::DescribeResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::DescribeResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::DescribeTransaction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::DescribeTransaction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::ExtendTransaction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::ExtendTransaction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetDataLakeSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetDataLakeSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetEffectivePermissionsForPath, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetEffectivePermissionsForPath, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetLFTag, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetLFTag, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetQueryState, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetQueryState, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetQueryStatistics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetQueryStatistics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetResourceLFTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetResourceLFTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetTableObjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetTableObjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetTemporaryGluePartitionCredentials, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetTemporaryGluePartitionCredentials, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetTemporaryGlueTableCredentials, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetTemporaryGlueTableCredentials, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetWorkUnitResults, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetWorkUnitResults, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GetWorkUnits, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GetWorkUnits, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::GrantPermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::GrantPermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::ListDataCellsFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::ListDataCellsFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::ListLFTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::ListLFTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::ListPermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::ListPermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::ListResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::ListResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::ListTableStorageOptimizers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::ListTableStorageOptimizers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::ListTransactions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::ListTransactions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::PutDataLakeSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::PutDataLakeSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::RegisterResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::RegisterResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::RemoveLFTagsFromResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::RemoveLFTagsFromResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::RevokePermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::RevokePermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::SearchDatabasesByLFTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::SearchDatabasesByLFTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::SearchTablesByLFTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::SearchTablesByLFTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::StartQueryPlanning, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::StartQueryPlanning, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::StartTransaction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::StartTransaction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::UpdateLFTag, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::UpdateLFTag, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::UpdateResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::UpdateResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::UpdateTableObjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::UpdateTableObjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LakeFormationClient::UpdateTableStorageOptimizer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LakeFormationClient::UpdateTableStorageOptimizer, this, request, handler, context, m_executor.get());
}
