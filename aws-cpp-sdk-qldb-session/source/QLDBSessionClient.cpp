...
{
  return MakeCallableOperation(ALLOCATION_TAG, &QLDBSessionClient::SendCommand, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&QLDBSessionClient::SendCommand, this, request, handler, context, m_executor.get());
}
