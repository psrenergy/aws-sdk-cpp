...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::AddApplicationCloudWatchLoggingOption, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::AddApplicationCloudWatchLoggingOption, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::AddApplicationInput, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::AddApplicationInput, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::AddApplicationInputProcessingConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::AddApplicationInputProcessingConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::AddApplicationOutput, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::AddApplicationOutput, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::AddApplicationReferenceDataSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::AddApplicationReferenceDataSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::AddApplicationVpcConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::AddApplicationVpcConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::CreateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::CreateApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::CreateApplicationPresignedUrl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::CreateApplicationPresignedUrl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::CreateApplicationSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::CreateApplicationSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DeleteApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DeleteApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DeleteApplicationCloudWatchLoggingOption, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DeleteApplicationCloudWatchLoggingOption, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DeleteApplicationInputProcessingConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DeleteApplicationInputProcessingConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DeleteApplicationOutput, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DeleteApplicationOutput, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DeleteApplicationReferenceDataSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DeleteApplicationReferenceDataSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DeleteApplicationSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DeleteApplicationSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DeleteApplicationVpcConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DeleteApplicationVpcConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DescribeApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DescribeApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DescribeApplicationSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DescribeApplicationSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DescribeApplicationVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DescribeApplicationVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::DiscoverInputSchema, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::DiscoverInputSchema, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::ListApplicationSnapshots, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::ListApplicationSnapshots, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::ListApplicationVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::ListApplicationVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::ListApplications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::ListApplications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::RollbackApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::RollbackApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::StartApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::StartApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::StopApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::StopApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::UpdateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::UpdateApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisAnalyticsV2Client::UpdateApplicationMaintenanceConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisAnalyticsV2Client::UpdateApplicationMaintenanceConfiguration, this, request, handler, context, m_executor.get());
}
