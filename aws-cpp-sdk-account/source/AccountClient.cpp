...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AccountClient::DeleteAlternateContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AccountClient::DeleteAlternateContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AccountClient::GetAlternateContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AccountClient::GetAlternateContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AccountClient::GetContactInformation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AccountClient::GetContactInformation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AccountClient::PutAlternateContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AccountClient::PutAlternateContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AccountClient::PutContactInformation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AccountClient::PutContactInformation, this, request, handler, context, m_executor.get());
}
