...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DLMClient::CreateLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DLMClient::CreateLifecyclePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DLMClient::DeleteLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DLMClient::DeleteLifecyclePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DLMClient::GetLifecyclePolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DLMClient::GetLifecyclePolicies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DLMClient::GetLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DLMClient::GetLifecyclePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DLMClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DLMClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DLMClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DLMClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DLMClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DLMClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DLMClient::UpdateLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DLMClient::UpdateLifecyclePolicy, this, request, handler, context, m_executor.get());
}
