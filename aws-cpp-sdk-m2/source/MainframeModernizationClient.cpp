...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::CancelBatchJobExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::CancelBatchJobExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::CreateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::CreateApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::CreateDataSetImportTask, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::CreateDataSetImportTask, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::CreateDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::CreateDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::CreateEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::CreateEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::DeleteApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::DeleteApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::DeleteApplicationFromEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::DeleteApplicationFromEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::DeleteEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::DeleteEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::GetApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::GetApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::GetApplicationVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::GetApplicationVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::GetBatchJobExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::GetBatchJobExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::GetDataSetDetails, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::GetDataSetDetails, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::GetDataSetImportTask, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::GetDataSetImportTask, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::GetDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::GetDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::GetEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::GetEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListApplicationVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListApplicationVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListApplications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListApplications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListBatchJobDefinitions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListBatchJobDefinitions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListBatchJobExecutions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListBatchJobExecutions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListDataSetImportHistory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListDataSetImportHistory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListDataSets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListDataSets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListDeployments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListDeployments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListEngineVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListEngineVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListEnvironments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListEnvironments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::StartApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::StartApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::StartBatchJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::StartBatchJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::StopApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::StopApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::UpdateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::UpdateApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MainframeModernizationClient::UpdateEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MainframeModernizationClient::UpdateEnvironment, this, request, handler, context, m_executor.get());
}
