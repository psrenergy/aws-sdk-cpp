...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTJobsDataPlaneClient::DescribeJobExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTJobsDataPlaneClient::DescribeJobExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTJobsDataPlaneClient::GetPendingJobExecutions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTJobsDataPlaneClient::GetPendingJobExecutions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTJobsDataPlaneClient::StartNextPendingJobExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTJobsDataPlaneClient::StartNextPendingJobExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTJobsDataPlaneClient::UpdateJobExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTJobsDataPlaneClient::UpdateJobExecution, this, request, handler, context, m_executor.get());
}
