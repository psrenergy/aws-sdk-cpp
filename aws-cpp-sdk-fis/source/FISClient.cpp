...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::CreateExperimentTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::CreateExperimentTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::DeleteExperimentTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::DeleteExperimentTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::GetAction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::GetAction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::GetExperiment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::GetExperiment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::GetExperimentTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::GetExperimentTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::GetTargetResourceType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::GetTargetResourceType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::ListActions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::ListActions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::ListExperimentTemplates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::ListExperimentTemplates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::ListExperiments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::ListExperiments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::ListTargetResourceTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::ListTargetResourceTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::StartExperiment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::StartExperiment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::StopExperiment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::StopExperiment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &FISClient::UpdateExperimentTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&FISClient::UpdateExperimentTemplate, this, request, handler, context, m_executor.get());
}
