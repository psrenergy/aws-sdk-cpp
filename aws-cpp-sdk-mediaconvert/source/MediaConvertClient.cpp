...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::AssociateCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::AssociateCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::CancelJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::CancelJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::CreateJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::CreateJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::CreateJobTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::CreateJobTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::CreatePreset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::CreatePreset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::CreateQueue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::CreateQueue, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::DeleteJobTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::DeleteJobTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::DeletePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::DeletePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::DeletePreset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::DeletePreset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::DeleteQueue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::DeleteQueue, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::DescribeEndpoints, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::DescribeEndpoints, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::DisassociateCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::DisassociateCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::GetJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::GetJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::GetJobTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::GetJobTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::GetPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::GetPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::GetPreset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::GetPreset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::GetQueue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::GetQueue, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::ListJobTemplates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::ListJobTemplates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::ListJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::ListJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::ListPresets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::ListPresets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::ListQueues, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::ListQueues, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::PutPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::PutPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::UpdateJobTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::UpdateJobTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::UpdatePreset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::UpdatePreset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConvertClient::UpdateQueue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConvertClient::UpdateQueue, this, request, handler, context, m_executor.get());
}
