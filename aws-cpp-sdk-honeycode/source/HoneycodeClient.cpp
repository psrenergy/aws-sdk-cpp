...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::BatchCreateTableRows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::BatchCreateTableRows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::BatchDeleteTableRows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::BatchDeleteTableRows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::BatchUpdateTableRows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::BatchUpdateTableRows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::BatchUpsertTableRows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::BatchUpsertTableRows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::DescribeTableDataImportJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::DescribeTableDataImportJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::GetScreenData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::GetScreenData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::InvokeScreenAutomation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::InvokeScreenAutomation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::ListTableColumns, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::ListTableColumns, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::ListTableRows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::ListTableRows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::ListTables, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::ListTables, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::QueryTableRows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::QueryTableRows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::StartTableDataImportJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::StartTableDataImportJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &HoneycodeClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&HoneycodeClient::UntagResource, this, request, handler, context, m_executor.get());
}
