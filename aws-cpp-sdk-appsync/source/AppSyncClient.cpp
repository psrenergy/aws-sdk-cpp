...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::AssociateApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::AssociateApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::CreateApiCache, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::CreateApiCache, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::CreateApiKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::CreateApiKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::CreateDataSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::CreateDataSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::CreateDomainName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::CreateDomainName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::CreateFunction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::CreateFunction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::CreateGraphqlApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::CreateGraphqlApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::CreateResolver, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::CreateResolver, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::CreateType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::CreateType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::DeleteApiCache, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::DeleteApiCache, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::DeleteApiKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::DeleteApiKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::DeleteDataSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::DeleteDataSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::DeleteDomainName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::DeleteDomainName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::DeleteFunction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::DeleteFunction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::DeleteGraphqlApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::DeleteGraphqlApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::DeleteResolver, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::DeleteResolver, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::DeleteType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::DeleteType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::DisassociateApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::DisassociateApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::EvaluateCode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::EvaluateCode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::EvaluateMappingTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::EvaluateMappingTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::FlushApiCache, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::FlushApiCache, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetApiAssociation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetApiAssociation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetApiCache, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetApiCache, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetDataSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetDataSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetDomainName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetDomainName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetFunction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetFunction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetGraphqlApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetGraphqlApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetIntrospectionSchema, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetIntrospectionSchema, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetResolver, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetResolver, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetSchemaCreationStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetSchemaCreationStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::GetType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::GetType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::ListApiKeys, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::ListApiKeys, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::ListDataSources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::ListDataSources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::ListDomainNames, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::ListDomainNames, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::ListFunctions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::ListFunctions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::ListGraphqlApis, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::ListGraphqlApis, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::ListResolvers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::ListResolvers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::ListResolversByFunction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::ListResolversByFunction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::ListTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::ListTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::StartSchemaCreation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::StartSchemaCreation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::UpdateApiCache, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::UpdateApiCache, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::UpdateApiKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::UpdateApiKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::UpdateDataSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::UpdateDataSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::UpdateDomainName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::UpdateDomainName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::UpdateFunction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::UpdateFunction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::UpdateGraphqlApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::UpdateGraphqlApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::UpdateResolver, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::UpdateResolver, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppSyncClient::UpdateType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppSyncClient::UpdateType, this, request, handler, context, m_executor.get());
}
