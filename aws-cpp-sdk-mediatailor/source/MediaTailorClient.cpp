...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::ConfigureLogsForPlaybackConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::ConfigureLogsForPlaybackConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::CreateChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::CreateChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::CreateLiveSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::CreateLiveSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::CreatePrefetchSchedule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::CreatePrefetchSchedule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::CreateProgram, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::CreateProgram, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::CreateSourceLocation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::CreateSourceLocation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::CreateVodSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::CreateVodSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DeleteChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DeleteChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DeleteChannelPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DeleteChannelPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DeleteLiveSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DeleteLiveSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DeletePlaybackConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DeletePlaybackConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DeletePrefetchSchedule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DeletePrefetchSchedule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DeleteProgram, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DeleteProgram, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DeleteSourceLocation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DeleteSourceLocation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DeleteVodSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DeleteVodSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DescribeChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DescribeChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DescribeLiveSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DescribeLiveSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DescribeProgram, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DescribeProgram, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DescribeSourceLocation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DescribeSourceLocation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::DescribeVodSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::DescribeVodSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::GetChannelPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::GetChannelPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::GetChannelSchedule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::GetChannelSchedule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::GetPlaybackConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::GetPlaybackConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::GetPrefetchSchedule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::GetPrefetchSchedule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::ListAlerts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::ListAlerts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::ListChannels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::ListChannels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::ListLiveSources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::ListLiveSources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::ListPlaybackConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::ListPlaybackConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::ListPrefetchSchedules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::ListPrefetchSchedules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::ListSourceLocations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::ListSourceLocations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::ListVodSources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::ListVodSources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::PutChannelPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::PutChannelPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::PutPlaybackConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::PutPlaybackConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::StartChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::StartChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::StopChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::StopChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::UpdateChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::UpdateChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::UpdateLiveSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::UpdateLiveSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::UpdateSourceLocation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::UpdateSourceLocation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaTailorClient::UpdateVodSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaTailorClient::UpdateVodSource, this, request, handler, context, m_executor.get());
}
