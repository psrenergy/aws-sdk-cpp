...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::AcceptQualificationRequest, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::AcceptQualificationRequest, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ApproveAssignment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ApproveAssignment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::AssociateQualificationWithWorker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::AssociateQualificationWithWorker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::CreateAdditionalAssignmentsForHIT, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::CreateAdditionalAssignmentsForHIT, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::CreateHIT, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::CreateHIT, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::CreateHITType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::CreateHITType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::CreateHITWithHITType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::CreateHITWithHITType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::CreateQualificationType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::CreateQualificationType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::CreateWorkerBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::CreateWorkerBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::DeleteHIT, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::DeleteHIT, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::DeleteQualificationType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::DeleteQualificationType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::DeleteWorkerBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::DeleteWorkerBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::DisassociateQualificationFromWorker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::DisassociateQualificationFromWorker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::GetAccountBalance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::GetAccountBalance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::GetAssignment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::GetAssignment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::GetFileUploadURL, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::GetFileUploadURL, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::GetHIT, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::GetHIT, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::GetQualificationScore, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::GetQualificationScore, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::GetQualificationType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::GetQualificationType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListAssignmentsForHIT, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListAssignmentsForHIT, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListBonusPayments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListBonusPayments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListHITs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListHITs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListHITsForQualificationType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListHITsForQualificationType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListQualificationRequests, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListQualificationRequests, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListQualificationTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListQualificationTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListReviewPolicyResultsForHIT, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListReviewPolicyResultsForHIT, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListReviewableHITs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListReviewableHITs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListWorkerBlocks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListWorkerBlocks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::ListWorkersWithQualificationType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::ListWorkersWithQualificationType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::NotifyWorkers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::NotifyWorkers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::RejectAssignment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::RejectAssignment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::RejectQualificationRequest, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::RejectQualificationRequest, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::SendBonus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::SendBonus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::SendTestEventNotification, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::SendTestEventNotification, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::UpdateExpirationForHIT, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::UpdateExpirationForHIT, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::UpdateHITReviewStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::UpdateHITReviewStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::UpdateHITTypeOfHIT, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::UpdateHITTypeOfHIT, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::UpdateNotificationSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::UpdateNotificationSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MTurkClient::UpdateQualificationType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MTurkClient::UpdateQualificationType, this, request, handler, context, m_executor.get());
}
