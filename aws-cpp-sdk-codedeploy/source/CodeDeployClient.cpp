...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::AddTagsToOnPremisesInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::AddTagsToOnPremisesInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::BatchGetApplicationRevisions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::BatchGetApplicationRevisions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::BatchGetApplications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::BatchGetApplications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::BatchGetDeploymentGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::BatchGetDeploymentGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::BatchGetDeploymentTargets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::BatchGetDeploymentTargets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::BatchGetDeployments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::BatchGetDeployments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::BatchGetOnPremisesInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::BatchGetOnPremisesInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ContinueDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ContinueDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::CreateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::CreateApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::CreateDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::CreateDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::CreateDeploymentConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::CreateDeploymentConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::CreateDeploymentGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::CreateDeploymentGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::DeleteApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::DeleteApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::DeleteDeploymentConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::DeleteDeploymentConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::DeleteDeploymentGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::DeleteDeploymentGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::DeleteGitHubAccountToken, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::DeleteGitHubAccountToken, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::DeleteResourcesByExternalId, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::DeleteResourcesByExternalId, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::DeregisterOnPremisesInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::DeregisterOnPremisesInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::GetApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::GetApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::GetApplicationRevision, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::GetApplicationRevision, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::GetDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::GetDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::GetDeploymentConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::GetDeploymentConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::GetDeploymentGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::GetDeploymentGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::GetDeploymentTarget, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::GetDeploymentTarget, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::GetOnPremisesInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::GetOnPremisesInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ListApplicationRevisions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ListApplicationRevisions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ListApplications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ListApplications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ListDeploymentConfigs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ListDeploymentConfigs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ListDeploymentGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ListDeploymentGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ListDeploymentTargets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ListDeploymentTargets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ListDeployments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ListDeployments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ListGitHubAccountTokenNames, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ListGitHubAccountTokenNames, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ListOnPremisesInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ListOnPremisesInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::PutLifecycleEventHookExecutionStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::PutLifecycleEventHookExecutionStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::RegisterApplicationRevision, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::RegisterApplicationRevision, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::RegisterOnPremisesInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::RegisterOnPremisesInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::RemoveTagsFromOnPremisesInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::RemoveTagsFromOnPremisesInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::StopDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::StopDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::UpdateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::UpdateApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeDeployClient::UpdateDeploymentGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeDeployClient::UpdateDeploymentGroup, this, request, handler, context, m_executor.get());
}
