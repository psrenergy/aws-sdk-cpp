...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::AcceptInvitation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::AcceptInvitation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::BatchGetCustomDataIdentifiers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::BatchGetCustomDataIdentifiers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::CreateAllowList, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::CreateAllowList, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::CreateClassificationJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::CreateClassificationJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::CreateCustomDataIdentifier, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::CreateCustomDataIdentifier, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::CreateFindingsFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::CreateFindingsFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::CreateInvitations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::CreateInvitations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::CreateMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::CreateMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::CreateSampleFindings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::CreateSampleFindings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DeclineInvitations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DeclineInvitations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DeleteAllowList, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DeleteAllowList, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DeleteCustomDataIdentifier, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DeleteCustomDataIdentifier, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DeleteFindingsFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DeleteFindingsFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DeleteInvitations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DeleteInvitations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DeleteMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DeleteMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DescribeBuckets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DescribeBuckets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DescribeClassificationJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DescribeClassificationJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DescribeOrganizationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DescribeOrganizationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DisableMacie, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DisableMacie, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DisableOrganizationAdminAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DisableOrganizationAdminAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DisassociateFromAdministratorAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DisassociateFromAdministratorAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DisassociateFromMasterAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DisassociateFromMasterAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::DisassociateMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::DisassociateMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::EnableMacie, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::EnableMacie, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::EnableOrganizationAdminAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::EnableOrganizationAdminAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetAdministratorAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetAdministratorAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetAllowList, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetAllowList, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetBucketStatistics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetBucketStatistics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetClassificationExportConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetClassificationExportConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetCustomDataIdentifier, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetCustomDataIdentifier, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetFindingStatistics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetFindingStatistics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetFindings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetFindings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetFindingsFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetFindingsFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetFindingsPublicationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetFindingsPublicationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetInvitationsCount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetInvitationsCount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetMacieSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetMacieSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetMasterAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetMasterAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetRevealConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetRevealConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetSensitiveDataOccurrences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetSensitiveDataOccurrences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetSensitiveDataOccurrencesAvailability, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetSensitiveDataOccurrencesAvailability, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetUsageStatistics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetUsageStatistics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::GetUsageTotals, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::GetUsageTotals, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListAllowLists, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListAllowLists, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListClassificationJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListClassificationJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListCustomDataIdentifiers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListCustomDataIdentifiers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListFindings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListFindings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListFindingsFilters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListFindingsFilters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListInvitations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListInvitations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListManagedDataIdentifiers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListManagedDataIdentifiers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListMembers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListMembers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListOrganizationAdminAccounts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListOrganizationAdminAccounts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::PutClassificationExportConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::PutClassificationExportConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::PutFindingsPublicationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::PutFindingsPublicationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::SearchResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::SearchResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::TestCustomDataIdentifier, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::TestCustomDataIdentifier, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::UpdateAllowList, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::UpdateAllowList, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::UpdateClassificationJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::UpdateClassificationJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::UpdateFindingsFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::UpdateFindingsFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::UpdateMacieSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::UpdateMacieSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::UpdateMemberSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::UpdateMemberSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::UpdateOrganizationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::UpdateOrganizationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Macie2Client::UpdateRevealConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Macie2Client::UpdateRevealConfiguration, this, request, handler, context, m_executor.get());
}
