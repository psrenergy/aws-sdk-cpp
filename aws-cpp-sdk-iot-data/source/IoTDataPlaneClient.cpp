...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTDataPlaneClient::DeleteThingShadow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTDataPlaneClient::DeleteThingShadow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTDataPlaneClient::GetRetainedMessage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTDataPlaneClient::GetRetainedMessage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTDataPlaneClient::GetThingShadow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTDataPlaneClient::GetThingShadow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTDataPlaneClient::ListNamedShadowsForThing, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTDataPlaneClient::ListNamedShadowsForThing, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTDataPlaneClient::ListRetainedMessages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTDataPlaneClient::ListRetainedMessages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTDataPlaneClient::Publish, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTDataPlaneClient::Publish, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTDataPlaneClient::UpdateThingShadow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTDataPlaneClient::UpdateThingShadow, this, request, handler, context, m_executor.get());
}
