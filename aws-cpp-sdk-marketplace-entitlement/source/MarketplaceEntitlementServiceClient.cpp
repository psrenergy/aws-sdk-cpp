...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceEntitlementServiceClient::GetEntitlements, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceEntitlementServiceClient::GetEntitlements, this, request, handler, context, m_executor.get());
}
