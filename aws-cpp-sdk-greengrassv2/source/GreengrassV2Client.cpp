...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::AssociateServiceRoleToAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::AssociateServiceRoleToAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::BatchAssociateClientDeviceWithCoreDevice, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::BatchAssociateClientDeviceWithCoreDevice, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::BatchDisassociateClientDeviceFromCoreDevice, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::BatchDisassociateClientDeviceFromCoreDevice, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::CancelDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::CancelDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::CreateComponentVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::CreateComponentVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::CreateDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::CreateDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::DeleteComponent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::DeleteComponent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::DeleteCoreDevice, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::DeleteCoreDevice, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::DeleteDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::DeleteDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::DescribeComponent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::DescribeComponent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::DisassociateServiceRoleFromAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::DisassociateServiceRoleFromAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::GetComponent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::GetComponent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::GetComponentVersionArtifact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::GetComponentVersionArtifact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::GetConnectivityInfo, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::GetConnectivityInfo, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::GetCoreDevice, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::GetCoreDevice, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::GetDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::GetDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::GetServiceRoleForAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::GetServiceRoleForAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::ListClientDevicesAssociatedWithCoreDevice, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::ListClientDevicesAssociatedWithCoreDevice, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::ListComponentVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::ListComponentVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::ListComponents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::ListComponents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::ListCoreDevices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::ListCoreDevices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::ListDeployments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::ListDeployments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::ListEffectiveDeployments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::ListEffectiveDeployments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::ListInstalledComponents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::ListInstalledComponents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::ResolveComponentCandidates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::ResolveComponentCandidates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GreengrassV2Client::UpdateConnectivityInfo, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GreengrassV2Client::UpdateConnectivityInfo, this, request, handler, context, m_executor.get());
}
