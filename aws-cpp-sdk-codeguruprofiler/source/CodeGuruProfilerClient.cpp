...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::AddNotificationChannels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::AddNotificationChannels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::BatchGetFrameMetricData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::BatchGetFrameMetricData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::ConfigureAgent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::ConfigureAgent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::CreateProfilingGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::CreateProfilingGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::DeleteProfilingGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::DeleteProfilingGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::DescribeProfilingGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::DescribeProfilingGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::GetFindingsReportAccountSummary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::GetFindingsReportAccountSummary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::GetNotificationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::GetNotificationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::GetPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::GetPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::GetProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::GetProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::GetRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::GetRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::ListFindingsReports, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::ListFindingsReports, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::ListProfileTimes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::ListProfileTimes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::ListProfilingGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::ListProfilingGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::PostAgentProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::PostAgentProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::PutPermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::PutPermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::RemoveNotificationChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::RemoveNotificationChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::RemovePermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::RemovePermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::SubmitFeedback, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::SubmitFeedback, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeGuruProfilerClient::UpdateProfilingGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeGuruProfilerClient::UpdateProfilingGroup, this, request, handler, context, m_executor.get());
}
