...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::CreateAppInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::CreateAppInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::CreateAppInstanceAdmin, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::CreateAppInstanceAdmin, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::CreateAppInstanceUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::CreateAppInstanceUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::DeleteAppInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::DeleteAppInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::DeleteAppInstanceAdmin, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::DeleteAppInstanceAdmin, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::DeleteAppInstanceUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::DeleteAppInstanceUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::DeregisterAppInstanceUserEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::DeregisterAppInstanceUserEndpoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::DescribeAppInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::DescribeAppInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::DescribeAppInstanceAdmin, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::DescribeAppInstanceAdmin, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::DescribeAppInstanceUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::DescribeAppInstanceUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::DescribeAppInstanceUserEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::DescribeAppInstanceUserEndpoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::GetAppInstanceRetentionSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::GetAppInstanceRetentionSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::ListAppInstanceAdmins, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::ListAppInstanceAdmins, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::ListAppInstanceUserEndpoints, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::ListAppInstanceUserEndpoints, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::ListAppInstanceUsers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::ListAppInstanceUsers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::ListAppInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::ListAppInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::PutAppInstanceRetentionSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::PutAppInstanceRetentionSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::RegisterAppInstanceUserEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::RegisterAppInstanceUserEndpoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::UpdateAppInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::UpdateAppInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::UpdateAppInstanceUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::UpdateAppInstanceUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ChimeSDKIdentityClient::UpdateAppInstanceUserEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ChimeSDKIdentityClient::UpdateAppInstanceUserEndpoint, this, request, handler, context, m_executor.get());
}
