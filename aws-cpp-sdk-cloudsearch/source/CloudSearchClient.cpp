...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::BuildSuggesters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::BuildSuggesters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::CreateDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::CreateDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DefineAnalysisScheme, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DefineAnalysisScheme, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DefineExpression, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DefineExpression, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DefineIndexField, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DefineIndexField, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DefineSuggester, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DefineSuggester, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DeleteAnalysisScheme, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DeleteAnalysisScheme, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DeleteDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DeleteDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DeleteExpression, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DeleteExpression, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DeleteIndexField, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DeleteIndexField, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DeleteSuggester, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DeleteSuggester, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DescribeAnalysisSchemes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DescribeAnalysisSchemes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DescribeAvailabilityOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DescribeAvailabilityOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DescribeDomainEndpointOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DescribeDomainEndpointOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DescribeDomains, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DescribeDomains, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DescribeExpressions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DescribeExpressions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DescribeIndexFields, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DescribeIndexFields, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DescribeScalingParameters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DescribeScalingParameters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DescribeServiceAccessPolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DescribeServiceAccessPolicies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::DescribeSuggesters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::DescribeSuggesters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::IndexDocuments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::IndexDocuments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::ListDomainNames, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::ListDomainNames, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::UpdateAvailabilityOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::UpdateAvailabilityOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::UpdateDomainEndpointOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::UpdateDomainEndpointOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::UpdateScalingParameters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::UpdateScalingParameters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchClient::UpdateServiceAccessPolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchClient::UpdateServiceAccessPolicies, this, request, handler, context, m_executor.get());
}
