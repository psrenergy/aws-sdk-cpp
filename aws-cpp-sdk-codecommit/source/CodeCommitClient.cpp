...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::AssociateApprovalRuleTemplateWithRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::AssociateApprovalRuleTemplateWithRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::BatchAssociateApprovalRuleTemplateWithRepositories, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::BatchAssociateApprovalRuleTemplateWithRepositories, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::BatchDescribeMergeConflicts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::BatchDescribeMergeConflicts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::BatchDisassociateApprovalRuleTemplateFromRepositories, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::BatchDisassociateApprovalRuleTemplateFromRepositories, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::BatchGetCommits, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::BatchGetCommits, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::BatchGetRepositories, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::BatchGetRepositories, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::CreateApprovalRuleTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::CreateApprovalRuleTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::CreateBranch, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::CreateBranch, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::CreateCommit, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::CreateCommit, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::CreatePullRequest, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::CreatePullRequest, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::CreatePullRequestApprovalRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::CreatePullRequestApprovalRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::CreateRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::CreateRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::CreateUnreferencedMergeCommit, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::CreateUnreferencedMergeCommit, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::DeleteApprovalRuleTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::DeleteApprovalRuleTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::DeleteBranch, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::DeleteBranch, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::DeleteCommentContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::DeleteCommentContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::DeleteFile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::DeleteFile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::DeletePullRequestApprovalRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::DeletePullRequestApprovalRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::DeleteRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::DeleteRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::DescribeMergeConflicts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::DescribeMergeConflicts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::DescribePullRequestEvents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::DescribePullRequestEvents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::DisassociateApprovalRuleTemplateFromRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::DisassociateApprovalRuleTemplateFromRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::EvaluatePullRequestApprovalRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::EvaluatePullRequestApprovalRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetApprovalRuleTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetApprovalRuleTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetBlob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetBlob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetBranch, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetBranch, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetComment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetComment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetCommentReactions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetCommentReactions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetCommentsForComparedCommit, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetCommentsForComparedCommit, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetCommentsForPullRequest, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetCommentsForPullRequest, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetCommit, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetCommit, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetDifferences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetDifferences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetFile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetFile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetFolder, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetFolder, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetMergeCommit, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetMergeCommit, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetMergeConflicts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetMergeConflicts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetMergeOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetMergeOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetPullRequest, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetPullRequest, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetPullRequestApprovalStates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetPullRequestApprovalStates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetPullRequestOverrideState, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetPullRequestOverrideState, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::GetRepositoryTriggers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::GetRepositoryTriggers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::ListApprovalRuleTemplates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::ListApprovalRuleTemplates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::ListAssociatedApprovalRuleTemplatesForRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::ListAssociatedApprovalRuleTemplatesForRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::ListBranches, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::ListBranches, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::ListPullRequests, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::ListPullRequests, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::ListRepositories, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::ListRepositories, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::ListRepositoriesForApprovalRuleTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::ListRepositoriesForApprovalRuleTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::MergeBranchesByFastForward, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::MergeBranchesByFastForward, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::MergeBranchesBySquash, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::MergeBranchesBySquash, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::MergeBranchesByThreeWay, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::MergeBranchesByThreeWay, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::MergePullRequestByFastForward, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::MergePullRequestByFastForward, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::MergePullRequestBySquash, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::MergePullRequestBySquash, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::MergePullRequestByThreeWay, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::MergePullRequestByThreeWay, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::OverridePullRequestApprovalRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::OverridePullRequestApprovalRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::PostCommentForComparedCommit, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::PostCommentForComparedCommit, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::PostCommentForPullRequest, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::PostCommentForPullRequest, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::PostCommentReply, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::PostCommentReply, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::PutCommentReaction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::PutCommentReaction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::PutFile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::PutFile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::PutRepositoryTriggers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::PutRepositoryTriggers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::TestRepositoryTriggers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::TestRepositoryTriggers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdateApprovalRuleTemplateContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdateApprovalRuleTemplateContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdateApprovalRuleTemplateDescription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdateApprovalRuleTemplateDescription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdateApprovalRuleTemplateName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdateApprovalRuleTemplateName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdateComment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdateComment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdateDefaultBranch, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdateDefaultBranch, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdatePullRequestApprovalRuleContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdatePullRequestApprovalRuleContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdatePullRequestApprovalState, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdatePullRequestApprovalState, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdatePullRequestDescription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdatePullRequestDescription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdatePullRequestStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdatePullRequestStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdatePullRequestTitle, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdatePullRequestTitle, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdateRepositoryDescription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdateRepositoryDescription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeCommitClient::UpdateRepositoryName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeCommitClient::UpdateRepositoryName, this, request, handler, context, m_executor.get());
}
