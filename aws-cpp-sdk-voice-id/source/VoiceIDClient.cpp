...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::CreateDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::CreateDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::DeleteDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::DeleteDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::DeleteFraudster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::DeleteFraudster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::DeleteSpeaker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::DeleteSpeaker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::DescribeDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::DescribeDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::DescribeFraudster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::DescribeFraudster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::DescribeFraudsterRegistrationJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::DescribeFraudsterRegistrationJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::DescribeSpeaker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::DescribeSpeaker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::DescribeSpeakerEnrollmentJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::DescribeSpeakerEnrollmentJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::EvaluateSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::EvaluateSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::ListDomains, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::ListDomains, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::ListFraudsterRegistrationJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::ListFraudsterRegistrationJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::ListSpeakerEnrollmentJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::ListSpeakerEnrollmentJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::ListSpeakers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::ListSpeakers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::OptOutSpeaker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::OptOutSpeaker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::StartFraudsterRegistrationJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::StartFraudsterRegistrationJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::StartSpeakerEnrollmentJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::StartSpeakerEnrollmentJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &VoiceIDClient::UpdateDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&VoiceIDClient::UpdateDomain, this, request, handler, context, m_executor.get());
}
