...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::CreateAnomalyMonitor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::CreateAnomalyMonitor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::CreateAnomalySubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::CreateAnomalySubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::CreateCostCategoryDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::CreateCostCategoryDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::DeleteAnomalyMonitor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::DeleteAnomalyMonitor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::DeleteAnomalySubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::DeleteAnomalySubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::DeleteCostCategoryDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::DeleteCostCategoryDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::DescribeCostCategoryDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::DescribeCostCategoryDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetAnomalies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetAnomalies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetAnomalyMonitors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetAnomalyMonitors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetAnomalySubscriptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetAnomalySubscriptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetCostAndUsage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetCostAndUsage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetCostAndUsageWithResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetCostAndUsageWithResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetCostCategories, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetCostCategories, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetCostForecast, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetCostForecast, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetDimensionValues, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetDimensionValues, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetReservationCoverage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetReservationCoverage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetReservationPurchaseRecommendation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetReservationPurchaseRecommendation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetReservationUtilization, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetReservationUtilization, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetRightsizingRecommendation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetRightsizingRecommendation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetSavingsPlansCoverage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetSavingsPlansCoverage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetSavingsPlansPurchaseRecommendation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetSavingsPlansPurchaseRecommendation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetSavingsPlansUtilization, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetSavingsPlansUtilization, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetSavingsPlansUtilizationDetails, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetSavingsPlansUtilizationDetails, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::GetUsageForecast, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::GetUsageForecast, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::ListCostAllocationTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::ListCostAllocationTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::ListCostCategoryDefinitions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::ListCostCategoryDefinitions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::ProvideAnomalyFeedback, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::ProvideAnomalyFeedback, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::UpdateAnomalyMonitor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::UpdateAnomalyMonitor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::UpdateAnomalySubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::UpdateAnomalySubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::UpdateCostAllocationTagsStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::UpdateCostAllocationTagsStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CostExplorerClient::UpdateCostCategoryDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CostExplorerClient::UpdateCostCategoryDefinition, this, request, handler, context, m_executor.get());
}
