...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoSignalingChannelsClient::GetIceServerConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoSignalingChannelsClient::GetIceServerConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoSignalingChannelsClient::SendAlexaOfferToMaster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoSignalingChannelsClient::SendAlexaOfferToMaster, this, request, handler, context, m_executor.get());
}
