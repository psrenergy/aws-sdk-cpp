...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::CreateWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::CreateWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::CreateWorkflowStep, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::CreateWorkflowStep, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::CreateWorkflowStepGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::CreateWorkflowStepGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::DeleteWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::DeleteWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::DeleteWorkflowStep, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::DeleteWorkflowStep, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::DeleteWorkflowStepGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::DeleteWorkflowStepGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::GetTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::GetTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::GetTemplateStep, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::GetTemplateStep, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::GetTemplateStepGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::GetTemplateStepGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::GetWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::GetWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::GetWorkflowStep, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::GetWorkflowStep, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::GetWorkflowStepGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::GetWorkflowStepGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::ListPlugins, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::ListPlugins, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::ListTemplateStepGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::ListTemplateStepGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::ListTemplateSteps, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::ListTemplateSteps, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::ListTemplates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::ListTemplates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::ListWorkflowStepGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::ListWorkflowStepGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::ListWorkflowSteps, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::ListWorkflowSteps, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::ListWorkflows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::ListWorkflows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::RetryWorkflowStep, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::RetryWorkflowStep, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::StartWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::StartWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::StopWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::StopWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::UpdateWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::UpdateWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::UpdateWorkflowStep, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::UpdateWorkflowStep, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubOrchestratorClient::UpdateWorkflowStepGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubOrchestratorClient::UpdateWorkflowStepGroup, this, request, handler, context, m_executor.get());
}
