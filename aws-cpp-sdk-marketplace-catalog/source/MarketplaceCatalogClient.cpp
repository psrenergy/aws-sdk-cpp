...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceCatalogClient::CancelChangeSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceCatalogClient::CancelChangeSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceCatalogClient::DescribeChangeSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceCatalogClient::DescribeChangeSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceCatalogClient::DescribeEntity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceCatalogClient::DescribeEntity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceCatalogClient::ListChangeSets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceCatalogClient::ListChangeSets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceCatalogClient::ListEntities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceCatalogClient::ListEntities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceCatalogClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceCatalogClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceCatalogClient::StartChangeSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceCatalogClient::StartChangeSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceCatalogClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceCatalogClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceCatalogClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceCatalogClient::UntagResource, this, request, handler, context, m_executor.get());
}
