...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkMailMessageFlowClient::GetRawMessageContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkMailMessageFlowClient::GetRawMessageContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkMailMessageFlowClient::PutRawMessageContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkMailMessageFlowClient::PutRawMessageContent, this, request, handler, context, m_executor.get());
}
