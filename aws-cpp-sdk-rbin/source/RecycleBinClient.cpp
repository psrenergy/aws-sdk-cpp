...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RecycleBinClient::CreateRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RecycleBinClient::CreateRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RecycleBinClient::DeleteRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RecycleBinClient::DeleteRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RecycleBinClient::GetRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RecycleBinClient::GetRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RecycleBinClient::ListRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RecycleBinClient::ListRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RecycleBinClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RecycleBinClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RecycleBinClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RecycleBinClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RecycleBinClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RecycleBinClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RecycleBinClient::UpdateRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RecycleBinClient::UpdateRule, this, request, handler, context, m_executor.get());
}
