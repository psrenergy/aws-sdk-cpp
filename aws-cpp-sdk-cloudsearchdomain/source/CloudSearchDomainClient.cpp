...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchDomainClient::Search, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchDomainClient::Search, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchDomainClient::Suggest, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchDomainClient::Suggest, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudSearchDomainClient::UploadDocuments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudSearchDomainClient::UploadDocuments, this, request, handler, context, m_executor.get());
}
