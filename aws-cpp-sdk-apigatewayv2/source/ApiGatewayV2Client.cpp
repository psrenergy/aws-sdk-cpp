...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateApiMapping, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateApiMapping, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateAuthorizer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateAuthorizer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateDomainName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateDomainName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateIntegrationResponse, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateIntegrationResponse, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateModel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateModel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateRouteResponse, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateRouteResponse, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateStage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateStage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::CreateVpcLink, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::CreateVpcLink, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteAccessLogSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteAccessLogSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteApiMapping, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteApiMapping, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteAuthorizer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteAuthorizer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteCorsConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteCorsConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteDomainName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteDomainName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteIntegrationResponse, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteIntegrationResponse, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteModel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteModel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteRouteRequestParameter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteRouteRequestParameter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteRouteResponse, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteRouteResponse, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteRouteSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteRouteSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteStage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteStage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::DeleteVpcLink, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::DeleteVpcLink, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::ExportApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::ExportApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::ResetAuthorizersCache, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::ResetAuthorizersCache, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetApiMapping, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetApiMapping, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetApiMappings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetApiMappings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetApis, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetApis, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetAuthorizer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetAuthorizer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetAuthorizers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetAuthorizers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetDeployments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetDeployments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetDomainName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetDomainName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetDomainNames, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetDomainNames, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetIntegrationResponse, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetIntegrationResponse, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetIntegrationResponses, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetIntegrationResponses, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetIntegrations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetIntegrations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetModel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetModel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetModelTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetModelTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetModels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetModels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetRouteResponse, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetRouteResponse, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetRouteResponses, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetRouteResponses, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetRoutes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetRoutes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetStage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetStage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetStages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetStages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetVpcLink, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetVpcLink, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::GetVpcLinks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::GetVpcLinks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::ImportApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::ImportApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::ReimportApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::ReimportApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateApi, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateApi, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateApiMapping, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateApiMapping, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateAuthorizer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateAuthorizer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateDeployment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateDeployment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateDomainName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateDomainName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateIntegrationResponse, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateIntegrationResponse, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateModel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateModel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateRouteResponse, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateRouteResponse, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateStage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateStage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayV2Client::UpdateVpcLink, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayV2Client::UpdateVpcLink, this, request, handler, context, m_executor.get());
}
