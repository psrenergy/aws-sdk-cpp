...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElasticInferenceClient::DescribeAcceleratorOfferings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElasticInferenceClient::DescribeAcceleratorOfferings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElasticInferenceClient::DescribeAcceleratorTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElasticInferenceClient::DescribeAcceleratorTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElasticInferenceClient::DescribeAccelerators, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElasticInferenceClient::DescribeAccelerators, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElasticInferenceClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElasticInferenceClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElasticInferenceClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElasticInferenceClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElasticInferenceClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElasticInferenceClient::UntagResource, this, request, handler, context, m_executor.get());
}
