...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::CancelKeyDeletion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::CancelKeyDeletion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ConnectCustomKeyStore, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ConnectCustomKeyStore, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::CreateAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::CreateAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::CreateCustomKeyStore, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::CreateCustomKeyStore, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::CreateGrant, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::CreateGrant, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::CreateKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::CreateKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::Decrypt, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::Decrypt, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::DeleteAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::DeleteAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::DeleteCustomKeyStore, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::DeleteCustomKeyStore, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::DeleteImportedKeyMaterial, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::DeleteImportedKeyMaterial, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::DescribeCustomKeyStores, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::DescribeCustomKeyStores, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::DescribeKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::DescribeKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::DisableKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::DisableKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::DisableKeyRotation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::DisableKeyRotation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::DisconnectCustomKeyStore, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::DisconnectCustomKeyStore, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::EnableKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::EnableKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::EnableKeyRotation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::EnableKeyRotation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::Encrypt, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::Encrypt, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GenerateDataKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GenerateDataKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GenerateDataKeyPair, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GenerateDataKeyPair, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GenerateDataKeyPairWithoutPlaintext, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GenerateDataKeyPairWithoutPlaintext, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GenerateDataKeyWithoutPlaintext, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GenerateDataKeyWithoutPlaintext, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GenerateMac, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GenerateMac, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GenerateRandom, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GenerateRandom, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GetKeyPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GetKeyPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GetKeyRotationStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GetKeyRotationStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GetParametersForImport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GetParametersForImport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::GetPublicKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::GetPublicKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ImportKeyMaterial, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ImportKeyMaterial, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ListAliases, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ListAliases, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ListGrants, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ListGrants, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ListKeyPolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ListKeyPolicies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ListKeys, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ListKeys, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ListResourceTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ListResourceTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ListRetirableGrants, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ListRetirableGrants, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::PutKeyPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::PutKeyPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ReEncrypt, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ReEncrypt, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ReplicateKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ReplicateKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::RetireGrant, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::RetireGrant, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::RevokeGrant, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::RevokeGrant, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::ScheduleKeyDeletion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::ScheduleKeyDeletion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::Sign, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::Sign, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::UpdateAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::UpdateAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::UpdateCustomKeyStore, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::UpdateCustomKeyStore, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::UpdateKeyDescription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::UpdateKeyDescription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::UpdatePrimaryRegion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::UpdatePrimaryRegion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::Verify, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::Verify, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KMSClient::VerifyMac, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KMSClient::VerifyMac, this, request, handler, context, m_executor.get());
}
