...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::AssociateMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::AssociateMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::BatchGetAccountStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::BatchGetAccountStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::BatchGetFreeTrialInfo, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::BatchGetFreeTrialInfo, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::CancelFindingsReport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::CancelFindingsReport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::CreateFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::CreateFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::CreateFindingsReport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::CreateFindingsReport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::DeleteFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::DeleteFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::DescribeOrganizationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::DescribeOrganizationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::Disable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::Disable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::DisableDelegatedAdminAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::DisableDelegatedAdminAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::DisassociateMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::DisassociateMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::Enable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::Enable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::EnableDelegatedAdminAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::EnableDelegatedAdminAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::GetConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::GetConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::GetDelegatedAdminAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::GetDelegatedAdminAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::GetFindingsReportStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::GetFindingsReportStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::GetMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::GetMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListAccountPermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListAccountPermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListCoverage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListCoverage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListCoverageStatistics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListCoverageStatistics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListDelegatedAdminAccounts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListDelegatedAdminAccounts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListFilters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListFilters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListFindingAggregations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListFindingAggregations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListFindings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListFindings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListMembers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListMembers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::ListUsageTotals, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::ListUsageTotals, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::UpdateConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::UpdateConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::UpdateFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::UpdateFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Inspector2Client::UpdateOrganizationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Inspector2Client::UpdateOrganizationConfiguration, this, request, handler, context, m_executor.get());
}
