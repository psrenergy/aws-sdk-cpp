...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::BatchPutPropertyValues, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::BatchPutPropertyValues, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::CreateComponentType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::CreateComponentType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::CreateEntity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::CreateEntity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::CreateScene, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::CreateScene, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::CreateWorkspace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::CreateWorkspace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::DeleteComponentType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::DeleteComponentType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::DeleteEntity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::DeleteEntity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::DeleteScene, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::DeleteScene, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::DeleteWorkspace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::DeleteWorkspace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::ExecuteQuery, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::ExecuteQuery, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::GetComponentType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::GetComponentType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::GetEntity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::GetEntity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::GetPricingPlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::GetPricingPlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::GetPropertyValue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::GetPropertyValue, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::GetPropertyValueHistory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::GetPropertyValueHistory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::GetScene, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::GetScene, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::GetWorkspace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::GetWorkspace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::ListComponentTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::ListComponentTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::ListEntities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::ListEntities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::ListScenes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::ListScenes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::ListWorkspaces, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::ListWorkspaces, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::UpdateComponentType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::UpdateComponentType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::UpdateEntity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::UpdateEntity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::UpdatePricingPlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::UpdatePricingPlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::UpdateScene, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::UpdateScene, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IoTTwinMakerClient::UpdateWorkspace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IoTTwinMakerClient::UpdateWorkspace, this, request, handler, context, m_executor.get());
}
