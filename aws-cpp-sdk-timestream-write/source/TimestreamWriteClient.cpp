...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::CreateDatabase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::CreateDatabase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::CreateTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::CreateTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::DeleteDatabase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::DeleteDatabase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::DeleteTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::DeleteTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::DescribeDatabase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::DescribeDatabase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::DescribeEndpoints, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::DescribeEndpoints, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::DescribeTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::DescribeTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::ListDatabases, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::ListDatabases, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::ListTables, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::ListTables, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::UpdateDatabase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::UpdateDatabase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::UpdateTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::UpdateTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TimestreamWriteClient::WriteRecords, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TimestreamWriteClient::WriteRecords, this, request, handler, context, m_executor.get());
}
