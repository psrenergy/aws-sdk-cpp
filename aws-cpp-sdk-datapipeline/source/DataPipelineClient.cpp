...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::ActivatePipeline, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::ActivatePipeline, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::AddTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::AddTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::CreatePipeline, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::CreatePipeline, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::DeactivatePipeline, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::DeactivatePipeline, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::DeletePipeline, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::DeletePipeline, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::DescribeObjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::DescribeObjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::DescribePipelines, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::DescribePipelines, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::EvaluateExpression, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::EvaluateExpression, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::GetPipelineDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::GetPipelineDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::ListPipelines, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::ListPipelines, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::PollForTask, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::PollForTask, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::PutPipelineDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::PutPipelineDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::QueryObjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::QueryObjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::RemoveTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::RemoveTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::ReportTaskProgress, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::ReportTaskProgress, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::ReportTaskRunnerHeartbeat, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::ReportTaskRunnerHeartbeat, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::SetStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::SetStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::SetTaskStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::SetTaskStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DataPipelineClient::ValidatePipelineDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DataPipelineClient::ValidatePipelineDefinition, this, request, handler, context, m_executor.get());
}
