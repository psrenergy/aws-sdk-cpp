...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBStreamsClient::DescribeStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBStreamsClient::DescribeStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBStreamsClient::GetRecords, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBStreamsClient::GetRecords, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBStreamsClient::GetShardIterator, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBStreamsClient::GetShardIterator, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBStreamsClient::ListStreams, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBStreamsClient::ListStreams, this, request, handler, context, m_executor.get());
}
