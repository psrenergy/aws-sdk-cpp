...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::BatchCreateCustomVocabularyItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::BatchCreateCustomVocabularyItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::BatchDeleteCustomVocabularyItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::BatchDeleteCustomVocabularyItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::BatchUpdateCustomVocabularyItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::BatchUpdateCustomVocabularyItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::BuildBotLocale, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::BuildBotLocale, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateBot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateBot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateBotAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateBotAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateBotLocale, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateBotLocale, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateBotVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateBotVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateExport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateExport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateIntent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateIntent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateResourcePolicyStatement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateResourcePolicyStatement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateSlot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateSlot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateSlotType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateSlotType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::CreateUploadUrl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::CreateUploadUrl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteBot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteBot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteBotAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteBotAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteBotLocale, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteBotLocale, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteBotVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteBotVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteCustomVocabulary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteCustomVocabulary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteExport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteExport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteImport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteImport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteIntent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteIntent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteResourcePolicyStatement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteResourcePolicyStatement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteSlot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteSlot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteSlotType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteSlotType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DeleteUtterances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DeleteUtterances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeBot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeBot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeBotAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeBotAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeBotLocale, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeBotLocale, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeBotRecommendation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeBotRecommendation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeBotVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeBotVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeCustomVocabularyMetadata, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeCustomVocabularyMetadata, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeExport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeExport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeImport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeImport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeIntent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeIntent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeSlot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeSlot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::DescribeSlotType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::DescribeSlotType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListAggregatedUtterances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListAggregatedUtterances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListBotAliases, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListBotAliases, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListBotLocales, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListBotLocales, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListBotRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListBotRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListBotVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListBotVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListBots, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListBots, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListBuiltInIntents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListBuiltInIntents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListBuiltInSlotTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListBuiltInSlotTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListCustomVocabularyItems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListCustomVocabularyItems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListExports, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListExports, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListImports, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListImports, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListIntents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListIntents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListRecommendedIntents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListRecommendedIntents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListSlotTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListSlotTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListSlots, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListSlots, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::SearchAssociatedTranscripts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::SearchAssociatedTranscripts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::StartBotRecommendation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::StartBotRecommendation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::StartImport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::StartImport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::StopBotRecommendation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::StopBotRecommendation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UpdateBot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UpdateBot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UpdateBotAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UpdateBotAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UpdateBotLocale, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UpdateBotLocale, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UpdateBotRecommendation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UpdateBotRecommendation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UpdateExport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UpdateExport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UpdateIntent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UpdateIntent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UpdateResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UpdateResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UpdateSlot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UpdateSlot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexModelsV2Client::UpdateSlotType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexModelsV2Client::UpdateSlotType, this, request, handler, context, m_executor.get());
}
