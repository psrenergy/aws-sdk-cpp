...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::BatchExecuteStatement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::BatchExecuteStatement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::BatchGetItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::BatchGetItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::BatchWriteItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::BatchWriteItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::CreateBackup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::CreateBackup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::CreateGlobalTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::CreateGlobalTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::CreateTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::CreateTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DeleteBackup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DeleteBackup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DeleteItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DeleteItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DeleteTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DeleteTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeBackup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeBackup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeContinuousBackups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeContinuousBackups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeContributorInsights, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeContributorInsights, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeEndpoints, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeEndpoints, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeExport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeExport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeGlobalTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeGlobalTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeGlobalTableSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeGlobalTableSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeImport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeImport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeKinesisStreamingDestination, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeKinesisStreamingDestination, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeLimits, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeLimits, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeTableReplicaAutoScaling, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeTableReplicaAutoScaling, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DescribeTimeToLive, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DescribeTimeToLive, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::DisableKinesisStreamingDestination, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::DisableKinesisStreamingDestination, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::EnableKinesisStreamingDestination, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::EnableKinesisStreamingDestination, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ExecuteStatement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ExecuteStatement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ExecuteTransaction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ExecuteTransaction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ExportTableToPointInTime, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ExportTableToPointInTime, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::GetItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::GetItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ImportTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ImportTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ListBackups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ListBackups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ListContributorInsights, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ListContributorInsights, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ListExports, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ListExports, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ListGlobalTables, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ListGlobalTables, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ListImports, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ListImports, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ListTables, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ListTables, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::ListTagsOfResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::ListTagsOfResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::PutItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::PutItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::Query, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::Query, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::RestoreTableFromBackup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::RestoreTableFromBackup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::RestoreTableToPointInTime, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::RestoreTableToPointInTime, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::Scan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::Scan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::TransactGetItems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::TransactGetItems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::TransactWriteItems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::TransactWriteItems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::UpdateContinuousBackups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::UpdateContinuousBackups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::UpdateContributorInsights, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::UpdateContributorInsights, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::UpdateGlobalTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::UpdateGlobalTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::UpdateGlobalTableSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::UpdateGlobalTableSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::UpdateItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::UpdateItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::UpdateTable, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::UpdateTable, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::UpdateTableReplicaAutoScaling, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::UpdateTableReplicaAutoScaling, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DynamoDBClient::UpdateTimeToLive, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DynamoDBClient::UpdateTimeToLive, this, request, handler, context, m_executor.get());
}
