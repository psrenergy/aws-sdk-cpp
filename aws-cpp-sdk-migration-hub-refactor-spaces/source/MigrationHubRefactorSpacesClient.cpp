...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::CreateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::CreateApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::CreateEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::CreateEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::CreateRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::CreateRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::CreateService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::CreateService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::DeleteApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::DeleteApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::DeleteEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::DeleteEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::DeleteResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::DeleteResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::DeleteRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::DeleteRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::DeleteService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::DeleteService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::GetApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::GetApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::GetEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::GetEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::GetResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::GetResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::GetRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::GetRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::GetService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::GetService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::ListApplications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::ListApplications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::ListEnvironmentVpcs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::ListEnvironmentVpcs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::ListEnvironments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::ListEnvironments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::ListRoutes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::ListRoutes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::ListServices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::ListServices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::PutResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::PutResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MigrationHubRefactorSpacesClient::UpdateRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MigrationHubRefactorSpacesClient::UpdateRoute, this, request, handler, context, m_executor.get());
}
