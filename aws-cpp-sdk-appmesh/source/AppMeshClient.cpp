...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::CreateGatewayRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::CreateGatewayRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::CreateMesh, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::CreateMesh, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::CreateRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::CreateRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::CreateVirtualGateway, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::CreateVirtualGateway, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::CreateVirtualNode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::CreateVirtualNode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::CreateVirtualRouter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::CreateVirtualRouter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::CreateVirtualService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::CreateVirtualService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DeleteGatewayRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DeleteGatewayRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DeleteMesh, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DeleteMesh, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DeleteRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DeleteRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DeleteVirtualGateway, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DeleteVirtualGateway, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DeleteVirtualNode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DeleteVirtualNode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DeleteVirtualRouter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DeleteVirtualRouter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DeleteVirtualService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DeleteVirtualService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DescribeGatewayRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DescribeGatewayRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DescribeMesh, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DescribeMesh, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DescribeRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DescribeRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DescribeVirtualGateway, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DescribeVirtualGateway, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DescribeVirtualNode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DescribeVirtualNode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DescribeVirtualRouter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DescribeVirtualRouter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::DescribeVirtualService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::DescribeVirtualService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::ListGatewayRoutes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::ListGatewayRoutes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::ListMeshes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::ListMeshes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::ListRoutes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::ListRoutes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::ListVirtualGateways, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::ListVirtualGateways, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::ListVirtualNodes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::ListVirtualNodes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::ListVirtualRouters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::ListVirtualRouters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::ListVirtualServices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::ListVirtualServices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::UpdateGatewayRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::UpdateGatewayRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::UpdateMesh, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::UpdateMesh, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::UpdateRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::UpdateRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::UpdateVirtualGateway, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::UpdateVirtualGateway, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::UpdateVirtualNode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::UpdateVirtualNode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::UpdateVirtualRouter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::UpdateVirtualRouter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppMeshClient::UpdateVirtualService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppMeshClient::UpdateVirtualService, this, request, handler, context, m_executor.get());
}
