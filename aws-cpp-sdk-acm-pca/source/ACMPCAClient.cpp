...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::CreateCertificateAuthority, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::CreateCertificateAuthority, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::CreateCertificateAuthorityAuditReport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::CreateCertificateAuthorityAuditReport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::CreatePermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::CreatePermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::DeleteCertificateAuthority, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::DeleteCertificateAuthority, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::DeletePermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::DeletePermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::DeletePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::DeletePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::DescribeCertificateAuthority, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::DescribeCertificateAuthority, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::DescribeCertificateAuthorityAuditReport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::DescribeCertificateAuthorityAuditReport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::GetCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::GetCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::GetCertificateAuthorityCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::GetCertificateAuthorityCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::GetCertificateAuthorityCsr, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::GetCertificateAuthorityCsr, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::GetPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::GetPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::ImportCertificateAuthorityCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::ImportCertificateAuthorityCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::IssueCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::IssueCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::ListCertificateAuthorities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::ListCertificateAuthorities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::ListPermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::ListPermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::ListTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::ListTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::PutPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::PutPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::RestoreCertificateAuthority, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::RestoreCertificateAuthority, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::RevokeCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::RevokeCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::TagCertificateAuthority, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::TagCertificateAuthority, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::UntagCertificateAuthority, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::UntagCertificateAuthority, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMPCAClient::UpdateCertificateAuthority, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMPCAClient::UpdateCertificateAuthority, this, request, handler, context, m_executor.get());
}
