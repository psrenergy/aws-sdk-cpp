...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::CreateCallAnalyticsCategory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::CreateCallAnalyticsCategory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::CreateLanguageModel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::CreateLanguageModel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::CreateMedicalVocabulary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::CreateMedicalVocabulary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::CreateVocabulary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::CreateVocabulary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::CreateVocabularyFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::CreateVocabularyFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::DeleteCallAnalyticsCategory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::DeleteCallAnalyticsCategory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::DeleteCallAnalyticsJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::DeleteCallAnalyticsJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::DeleteLanguageModel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::DeleteLanguageModel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::DeleteMedicalTranscriptionJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::DeleteMedicalTranscriptionJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::DeleteMedicalVocabulary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::DeleteMedicalVocabulary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::DeleteTranscriptionJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::DeleteTranscriptionJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::DeleteVocabulary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::DeleteVocabulary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::DeleteVocabularyFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::DeleteVocabularyFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::DescribeLanguageModel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::DescribeLanguageModel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::GetCallAnalyticsCategory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::GetCallAnalyticsCategory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::GetCallAnalyticsJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::GetCallAnalyticsJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::GetMedicalTranscriptionJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::GetMedicalTranscriptionJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::GetMedicalVocabulary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::GetMedicalVocabulary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::GetTranscriptionJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::GetTranscriptionJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::GetVocabulary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::GetVocabulary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::GetVocabularyFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::GetVocabularyFilter, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::ListCallAnalyticsCategories, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::ListCallAnalyticsCategories, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::ListCallAnalyticsJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::ListCallAnalyticsJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::ListLanguageModels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::ListLanguageModels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::ListMedicalTranscriptionJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::ListMedicalTranscriptionJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::ListMedicalVocabularies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::ListMedicalVocabularies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::ListTranscriptionJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::ListTranscriptionJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::ListVocabularies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::ListVocabularies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::ListVocabularyFilters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::ListVocabularyFilters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::StartCallAnalyticsJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::StartCallAnalyticsJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::StartMedicalTranscriptionJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::StartMedicalTranscriptionJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::StartTranscriptionJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::StartTranscriptionJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::UpdateCallAnalyticsCategory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::UpdateCallAnalyticsCategory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::UpdateMedicalVocabulary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::UpdateMedicalVocabulary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::UpdateVocabulary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::UpdateVocabulary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TranscribeServiceClient::UpdateVocabularyFilter, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TranscribeServiceClient::UpdateVocabularyFilter, this, request, handler, context, m_executor.get());
}
