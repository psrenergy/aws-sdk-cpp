...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ActivateKeySigningKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ActivateKeySigningKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::AssociateVPCWithHostedZone, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::AssociateVPCWithHostedZone, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ChangeCidrCollection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ChangeCidrCollection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ChangeResourceRecordSets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ChangeResourceRecordSets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ChangeTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ChangeTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateCidrCollection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateCidrCollection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateHealthCheck, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateHealthCheck, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateHostedZone, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateHostedZone, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateKeySigningKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateKeySigningKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateQueryLoggingConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateQueryLoggingConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateReusableDelegationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateReusableDelegationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateTrafficPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateTrafficPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateTrafficPolicyInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateTrafficPolicyInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateTrafficPolicyVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateTrafficPolicyVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::CreateVPCAssociationAuthorization, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::CreateVPCAssociationAuthorization, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeactivateKeySigningKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeactivateKeySigningKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeleteCidrCollection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeleteCidrCollection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeleteHealthCheck, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeleteHealthCheck, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeleteHostedZone, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeleteHostedZone, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeleteKeySigningKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeleteKeySigningKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeleteQueryLoggingConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeleteQueryLoggingConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeleteReusableDelegationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeleteReusableDelegationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeleteTrafficPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeleteTrafficPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeleteTrafficPolicyInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeleteTrafficPolicyInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DeleteVPCAssociationAuthorization, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DeleteVPCAssociationAuthorization, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DisableHostedZoneDNSSEC, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DisableHostedZoneDNSSEC, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::DisassociateVPCFromHostedZone, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::DisassociateVPCFromHostedZone, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::EnableHostedZoneDNSSEC, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::EnableHostedZoneDNSSEC, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetAccountLimit, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetAccountLimit, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetChange, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetChange, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetCheckerIpRanges, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetCheckerIpRanges, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetDNSSEC, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetDNSSEC, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetGeoLocation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetGeoLocation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetHealthCheck, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetHealthCheck, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetHealthCheckCount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetHealthCheckCount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetHealthCheckLastFailureReason, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetHealthCheckLastFailureReason, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetHealthCheckStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetHealthCheckStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetHostedZone, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetHostedZone, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetHostedZoneCount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetHostedZoneCount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetHostedZoneLimit, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetHostedZoneLimit, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetQueryLoggingConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetQueryLoggingConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetReusableDelegationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetReusableDelegationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetReusableDelegationSetLimit, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetReusableDelegationSetLimit, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetTrafficPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetTrafficPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetTrafficPolicyInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetTrafficPolicyInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::GetTrafficPolicyInstanceCount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::GetTrafficPolicyInstanceCount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListCidrBlocks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListCidrBlocks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListCidrCollections, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListCidrCollections, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListCidrLocations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListCidrLocations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListGeoLocations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListGeoLocations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListHealthChecks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListHealthChecks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListHostedZones, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListHostedZones, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListHostedZonesByName, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListHostedZonesByName, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListHostedZonesByVPC, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListHostedZonesByVPC, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListQueryLoggingConfigs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListQueryLoggingConfigs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListResourceRecordSets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListResourceRecordSets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListReusableDelegationSets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListReusableDelegationSets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListTagsForResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListTagsForResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListTrafficPolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListTrafficPolicies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListTrafficPolicyInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListTrafficPolicyInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListTrafficPolicyInstancesByHostedZone, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListTrafficPolicyInstancesByHostedZone, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListTrafficPolicyInstancesByPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListTrafficPolicyInstancesByPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListTrafficPolicyVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListTrafficPolicyVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::ListVPCAssociationAuthorizations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::ListVPCAssociationAuthorizations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::TestDNSAnswer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::TestDNSAnswer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::UpdateHealthCheck, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::UpdateHealthCheck, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::UpdateHostedZoneComment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::UpdateHostedZoneComment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::UpdateTrafficPolicyComment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::UpdateTrafficPolicyComment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53Client::UpdateTrafficPolicyInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53Client::UpdateTrafficPolicyInstance, this, request, handler, context, m_executor.get());
}
