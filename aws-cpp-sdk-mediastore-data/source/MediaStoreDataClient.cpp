...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreDataClient::DeleteObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreDataClient::DeleteObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreDataClient::DescribeObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreDataClient::DescribeObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreDataClient::GetObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreDataClient::GetObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreDataClient::ListItems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreDataClient::ListItems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreDataClient::PutObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreDataClient::PutObject, this, request, handler, context, m_executor.get());
}
