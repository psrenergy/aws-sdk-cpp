...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SageMakerRuntimeClient::InvokeEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SageMakerRuntimeClient::InvokeEndpoint, this, request, handler, context, m_executor.get());
}
...
{
  typedef InvokeEndpointAsyncOutcome (SageMakerRuntimeClient::*RegularBlockingOperation)(const InvokeEndpointAsyncRequest&) const;
  RegularBlockingOperation regularBlockingOperation = &SageMakerRuntimeClient::InvokeEndpointAsync;
