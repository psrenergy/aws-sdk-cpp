...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::CancelJobRun, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::CancelJobRun, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::CreateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::CreateApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::DeleteApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::DeleteApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::GetApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::GetApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::GetDashboardForJobRun, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::GetDashboardForJobRun, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::GetJobRun, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::GetJobRun, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::ListApplications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::ListApplications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::ListJobRuns, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::ListJobRuns, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::StartApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::StartApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::StartJobRun, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::StartJobRun, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::StopApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::StopApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EMRServerlessClient::UpdateApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EMRServerlessClient::UpdateApplication, this, request, handler, context, m_executor.get());
}
