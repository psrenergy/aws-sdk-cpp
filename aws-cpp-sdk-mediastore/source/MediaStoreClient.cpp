...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::CreateContainer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::CreateContainer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::DeleteContainer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::DeleteContainer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::DeleteContainerPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::DeleteContainerPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::DeleteCorsPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::DeleteCorsPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::DeleteLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::DeleteLifecyclePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::DeleteMetricPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::DeleteMetricPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::DescribeContainer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::DescribeContainer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::GetContainerPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::GetContainerPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::GetCorsPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::GetCorsPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::GetLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::GetLifecyclePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::GetMetricPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::GetMetricPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::ListContainers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::ListContainers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::PutContainerPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::PutContainerPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::PutCorsPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::PutCorsPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::PutLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::PutLifecyclePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::PutMetricPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::PutMetricPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::StartAccessLogging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::StartAccessLogging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::StopAccessLogging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::StopAccessLogging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaStoreClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaStoreClient::UntagResource, this, request, handler, context, m_executor.get());
}
