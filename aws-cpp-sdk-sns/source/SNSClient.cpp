...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::AddPermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::AddPermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::CheckIfPhoneNumberIsOptedOut, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::CheckIfPhoneNumberIsOptedOut, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ConfirmSubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ConfirmSubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::CreatePlatformApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::CreatePlatformApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::CreatePlatformEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::CreatePlatformEndpoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::CreateSMSSandboxPhoneNumber, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::CreateSMSSandboxPhoneNumber, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::CreateTopic, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::CreateTopic, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::DeleteEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::DeleteEndpoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::DeletePlatformApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::DeletePlatformApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::DeleteSMSSandboxPhoneNumber, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::DeleteSMSSandboxPhoneNumber, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::DeleteTopic, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::DeleteTopic, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::GetDataProtectionPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::GetDataProtectionPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::GetEndpointAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::GetEndpointAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::GetPlatformApplicationAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::GetPlatformApplicationAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::GetSMSAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::GetSMSAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::GetSMSSandboxAccountStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::GetSMSSandboxAccountStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::GetSubscriptionAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::GetSubscriptionAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::GetTopicAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::GetTopicAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ListEndpointsByPlatformApplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ListEndpointsByPlatformApplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ListOriginationNumbers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ListOriginationNumbers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ListPhoneNumbersOptedOut, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ListPhoneNumbersOptedOut, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ListPlatformApplications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ListPlatformApplications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ListSMSSandboxPhoneNumbers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ListSMSSandboxPhoneNumbers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ListSubscriptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ListSubscriptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ListSubscriptionsByTopic, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ListSubscriptionsByTopic, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::ListTopics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::ListTopics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::OptInPhoneNumber, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::OptInPhoneNumber, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::Publish, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::Publish, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::PublishBatch, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::PublishBatch, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::PutDataProtectionPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::PutDataProtectionPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::RemovePermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::RemovePermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::SetEndpointAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::SetEndpointAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::SetPlatformApplicationAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::SetPlatformApplicationAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::SetSMSAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::SetSMSAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::SetSubscriptionAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::SetSubscriptionAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::SetTopicAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::SetTopicAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::Subscribe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::Subscribe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::Unsubscribe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::Unsubscribe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SNSClient::VerifySMSSandboxPhoneNumber, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SNSClient::VerifySMSSandboxPhoneNumber, this, request, handler, context, m_executor.get());
}
