...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ForecastQueryServiceClient::QueryForecast, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ForecastQueryServiceClient::QueryForecast, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ForecastQueryServiceClient::QueryWhatIfForecast, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ForecastQueryServiceClient::QueryWhatIfForecast, this, request, handler, context, m_executor.get());
}
