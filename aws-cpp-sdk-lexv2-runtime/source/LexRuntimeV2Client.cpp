...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexRuntimeV2Client::DeleteSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexRuntimeV2Client::DeleteSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexRuntimeV2Client::GetSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexRuntimeV2Client::GetSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexRuntimeV2Client::PutSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexRuntimeV2Client::PutSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexRuntimeV2Client::RecognizeText, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexRuntimeV2Client::RecognizeText, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LexRuntimeV2Client::RecognizeUtterance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LexRuntimeV2Client::RecognizeUtterance, this, request, handler, context, m_executor.get());
}
