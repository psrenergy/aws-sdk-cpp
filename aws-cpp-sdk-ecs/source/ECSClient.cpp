...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::CreateCapacityProvider, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::CreateCapacityProvider, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::CreateCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::CreateCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::CreateService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::CreateService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::CreateTaskSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::CreateTaskSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DeleteAccountSetting, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DeleteAccountSetting, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DeleteAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DeleteAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DeleteCapacityProvider, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DeleteCapacityProvider, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DeleteCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DeleteCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DeleteService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DeleteService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DeleteTaskSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DeleteTaskSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DeregisterContainerInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DeregisterContainerInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DeregisterTaskDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DeregisterTaskDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DescribeCapacityProviders, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DescribeCapacityProviders, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DescribeClusters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DescribeClusters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DescribeContainerInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DescribeContainerInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DescribeServices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DescribeServices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DescribeTaskDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DescribeTaskDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DescribeTaskSets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DescribeTaskSets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DescribeTasks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DescribeTasks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::DiscoverPollEndpoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::DiscoverPollEndpoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ExecuteCommand, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ExecuteCommand, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::GetTaskProtection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::GetTaskProtection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ListAccountSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ListAccountSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ListAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ListAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ListClusters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ListClusters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ListContainerInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ListContainerInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ListServices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ListServices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ListTaskDefinitionFamilies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ListTaskDefinitionFamilies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ListTaskDefinitions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ListTaskDefinitions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::ListTasks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::ListTasks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::PutAccountSetting, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::PutAccountSetting, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::PutAccountSettingDefault, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::PutAccountSettingDefault, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::PutAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::PutAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::PutClusterCapacityProviders, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::PutClusterCapacityProviders, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::RegisterContainerInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::RegisterContainerInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::RegisterTaskDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::RegisterTaskDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::RunTask, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::RunTask, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::StartTask, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::StartTask, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::StopTask, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::StopTask, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::SubmitAttachmentStateChanges, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::SubmitAttachmentStateChanges, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::SubmitContainerStateChange, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::SubmitContainerStateChange, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::SubmitTaskStateChange, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::SubmitTaskStateChange, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UpdateCapacityProvider, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UpdateCapacityProvider, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UpdateCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UpdateCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UpdateClusterSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UpdateClusterSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UpdateContainerAgent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UpdateContainerAgent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UpdateContainerInstancesState, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UpdateContainerInstancesState, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UpdateService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UpdateService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UpdateServicePrimaryTaskSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UpdateServicePrimaryTaskSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UpdateTaskProtection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UpdateTaskProtection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECSClient::UpdateTaskSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECSClient::UpdateTaskSet, this, request, handler, context, m_executor.get());
}
