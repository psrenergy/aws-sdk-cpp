...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::AcceptDomainTransferFromAnotherAwsAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::AcceptDomainTransferFromAnotherAwsAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::CancelDomainTransferToAnotherAwsAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::CancelDomainTransferToAnotherAwsAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::CheckDomainAvailability, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::CheckDomainAvailability, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::CheckDomainTransferability, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::CheckDomainTransferability, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::DeleteDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::DeleteDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::DeleteTagsForDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::DeleteTagsForDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::DisableDomainAutoRenew, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::DisableDomainAutoRenew, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::DisableDomainTransferLock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::DisableDomainTransferLock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::EnableDomainAutoRenew, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::EnableDomainAutoRenew, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::EnableDomainTransferLock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::EnableDomainTransferLock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::GetContactReachabilityStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::GetContactReachabilityStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::GetDomainDetail, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::GetDomainDetail, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::GetDomainSuggestions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::GetDomainSuggestions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::GetOperationDetail, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::GetOperationDetail, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::ListDomains, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::ListDomains, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::ListOperations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::ListOperations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::ListPrices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::ListPrices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::ListTagsForDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::ListTagsForDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::RegisterDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::RegisterDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::RejectDomainTransferFromAnotherAwsAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::RejectDomainTransferFromAnotherAwsAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::RenewDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::RenewDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::ResendContactReachabilityEmail, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::ResendContactReachabilityEmail, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::RetrieveDomainAuthCode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::RetrieveDomainAuthCode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::TransferDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::TransferDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::TransferDomainToAnotherAwsAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::TransferDomainToAnotherAwsAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::UpdateDomainContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::UpdateDomainContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::UpdateDomainContactPrivacy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::UpdateDomainContactPrivacy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::UpdateDomainNameservers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::UpdateDomainNameservers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::UpdateTagsForDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::UpdateTagsForDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Route53DomainsClient::ViewBilling, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Route53DomainsClient::ViewBilling, this, request, handler, context, m_executor.get());
}
