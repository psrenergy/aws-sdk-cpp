...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::BatchCheckLayerAvailability, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::BatchCheckLayerAvailability, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::BatchDeleteImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::BatchDeleteImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::CompleteLayerUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::CompleteLayerUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::CreateRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::CreateRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::DeleteRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::DeleteRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::DeleteRepositoryPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::DeleteRepositoryPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::DescribeImageTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::DescribeImageTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::DescribeImages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::DescribeImages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::DescribeRegistries, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::DescribeRegistries, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::DescribeRepositories, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::DescribeRepositories, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::GetAuthorizationToken, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::GetAuthorizationToken, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::GetRegistryCatalogData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::GetRegistryCatalogData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::GetRepositoryCatalogData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::GetRepositoryCatalogData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::GetRepositoryPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::GetRepositoryPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::InitiateLayerUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::InitiateLayerUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::PutImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::PutImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::PutRegistryCatalogData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::PutRegistryCatalogData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::PutRepositoryCatalogData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::PutRepositoryCatalogData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::SetRepositoryPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::SetRepositoryPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRPublicClient::UploadLayerPart, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRPublicClient::UploadLayerPart, this, request, handler, context, m_executor.get());
}
