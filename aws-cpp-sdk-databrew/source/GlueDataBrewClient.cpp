...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::BatchDeleteRecipeVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::BatchDeleteRecipeVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::CreateDataset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::CreateDataset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::CreateProfileJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::CreateProfileJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::CreateProject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::CreateProject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::CreateRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::CreateRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::CreateRecipeJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::CreateRecipeJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::CreateRuleset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::CreateRuleset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::CreateSchedule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::CreateSchedule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DeleteDataset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DeleteDataset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DeleteJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DeleteJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DeleteProject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DeleteProject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DeleteRecipeVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DeleteRecipeVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DeleteRuleset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DeleteRuleset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DeleteSchedule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DeleteSchedule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DescribeDataset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DescribeDataset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DescribeJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DescribeJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DescribeJobRun, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DescribeJobRun, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DescribeProject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DescribeProject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DescribeRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DescribeRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DescribeRuleset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DescribeRuleset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::DescribeSchedule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::DescribeSchedule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::ListDatasets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::ListDatasets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::ListJobRuns, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::ListJobRuns, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::ListJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::ListJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::ListProjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::ListProjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::ListRecipeVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::ListRecipeVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::ListRecipes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::ListRecipes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::ListRulesets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::ListRulesets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::ListSchedules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::ListSchedules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::PublishRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::PublishRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::SendProjectSessionAction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::SendProjectSessionAction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::StartJobRun, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::StartJobRun, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::StartProjectSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::StartProjectSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::StopJobRun, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::StopJobRun, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::UpdateDataset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::UpdateDataset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::UpdateProfileJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::UpdateProfileJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::UpdateProject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::UpdateProject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::UpdateRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::UpdateRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::UpdateRecipeJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::UpdateRecipeJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::UpdateRuleset, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::UpdateRuleset, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GlueDataBrewClient::UpdateSchedule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GlueDataBrewClient::UpdateSchedule, this, request, handler, context, m_executor.get());
}
