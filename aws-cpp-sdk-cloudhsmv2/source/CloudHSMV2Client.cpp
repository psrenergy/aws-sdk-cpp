...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::CopyBackupToRegion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::CopyBackupToRegion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::CreateCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::CreateCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::CreateHsm, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::CreateHsm, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::DeleteBackup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::DeleteBackup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::DeleteCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::DeleteCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::DeleteHsm, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::DeleteHsm, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::DescribeBackups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::DescribeBackups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::DescribeClusters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::DescribeClusters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::InitializeCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::InitializeCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::ListTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::ListTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::ModifyBackupAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::ModifyBackupAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::ModifyCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::ModifyCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::RestoreBackup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::RestoreBackup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudHSMV2Client::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudHSMV2Client::UntagResource, this, request, handler, context, m_executor.get());
}
