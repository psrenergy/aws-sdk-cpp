...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::CreateNotificationRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::CreateNotificationRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::DeleteNotificationRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::DeleteNotificationRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::DeleteTarget, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::DeleteTarget, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::DescribeNotificationRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::DescribeNotificationRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::ListEventTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::ListEventTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::ListNotificationRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::ListNotificationRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::ListTargets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::ListTargets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::Subscribe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::Subscribe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::Unsubscribe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::Unsubscribe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CodeStarNotificationsClient::UpdateNotificationRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CodeStarNotificationsClient::UpdateNotificationRule, this, request, handler, context, m_executor.get());
}
