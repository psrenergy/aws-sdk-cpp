...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MobileClient::CreateProject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MobileClient::CreateProject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MobileClient::DeleteProject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MobileClient::DeleteProject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MobileClient::DescribeBundle, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MobileClient::DescribeBundle, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MobileClient::DescribeProject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MobileClient::DescribeProject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MobileClient::ExportBundle, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MobileClient::ExportBundle, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MobileClient::ExportProject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MobileClient::ExportProject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MobileClient::ListBundles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MobileClient::ListBundles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MobileClient::ListProjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MobileClient::ListProjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MobileClient::UpdateProject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MobileClient::UpdateProject, this, request, handler, context, m_executor.get());
}
