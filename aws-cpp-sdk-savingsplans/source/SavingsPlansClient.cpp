...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SavingsPlansClient::CreateSavingsPlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SavingsPlansClient::CreateSavingsPlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SavingsPlansClient::DeleteQueuedSavingsPlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SavingsPlansClient::DeleteQueuedSavingsPlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SavingsPlansClient::DescribeSavingsPlanRates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SavingsPlansClient::DescribeSavingsPlanRates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SavingsPlansClient::DescribeSavingsPlans, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SavingsPlansClient::DescribeSavingsPlans, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SavingsPlansClient::DescribeSavingsPlansOfferingRates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SavingsPlansClient::DescribeSavingsPlansOfferingRates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SavingsPlansClient::DescribeSavingsPlansOfferings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SavingsPlansClient::DescribeSavingsPlansOfferings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SavingsPlansClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SavingsPlansClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SavingsPlansClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SavingsPlansClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SavingsPlansClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SavingsPlansClient::UntagResource, this, request, handler, context, m_executor.get());
}
