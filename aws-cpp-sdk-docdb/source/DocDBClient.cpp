...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::AddSourceIdentifierToSubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::AddSourceIdentifierToSubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::AddTagsToResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::AddTagsToResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ApplyPendingMaintenanceAction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ApplyPendingMaintenanceAction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::CopyDBClusterParameterGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::CopyDBClusterParameterGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::CopyDBClusterSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::CopyDBClusterSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::CreateDBCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::CreateDBCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::CreateDBClusterParameterGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::CreateDBClusterParameterGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::CreateDBClusterSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::CreateDBClusterSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::CreateDBInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::CreateDBInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::CreateDBSubnetGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::CreateDBSubnetGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::CreateEventSubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::CreateEventSubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::CreateGlobalCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::CreateGlobalCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DeleteDBCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DeleteDBCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DeleteDBClusterParameterGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DeleteDBClusterParameterGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DeleteDBClusterSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DeleteDBClusterSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DeleteDBInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DeleteDBInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DeleteDBSubnetGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DeleteDBSubnetGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DeleteEventSubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DeleteEventSubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DeleteGlobalCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DeleteGlobalCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeCertificates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeCertificates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeDBClusterParameterGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeDBClusterParameterGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeDBClusterParameters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeDBClusterParameters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeDBClusterSnapshotAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeDBClusterSnapshotAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeDBClusterSnapshots, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeDBClusterSnapshots, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeDBClusters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeDBClusters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeDBEngineVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeDBEngineVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeDBInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeDBInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeDBSubnetGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeDBSubnetGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeEngineDefaultClusterParameters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeEngineDefaultClusterParameters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeEventCategories, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeEventCategories, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeEventSubscriptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeEventSubscriptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeEvents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeEvents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeGlobalClusters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeGlobalClusters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribeOrderableDBInstanceOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribeOrderableDBInstanceOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::DescribePendingMaintenanceActions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::DescribePendingMaintenanceActions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::FailoverDBCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::FailoverDBCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ModifyDBCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ModifyDBCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ModifyDBClusterParameterGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ModifyDBClusterParameterGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ModifyDBClusterSnapshotAttribute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ModifyDBClusterSnapshotAttribute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ModifyDBInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ModifyDBInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ModifyDBSubnetGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ModifyDBSubnetGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ModifyEventSubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ModifyEventSubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ModifyGlobalCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ModifyGlobalCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::RebootDBInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::RebootDBInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::RemoveFromGlobalCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::RemoveFromGlobalCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::RemoveSourceIdentifierFromSubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::RemoveSourceIdentifierFromSubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::RemoveTagsFromResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::RemoveTagsFromResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::ResetDBClusterParameterGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::ResetDBClusterParameterGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::RestoreDBClusterFromSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::RestoreDBClusterFromSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::RestoreDBClusterToPointInTime, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::RestoreDBClusterToPointInTime, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::StartDBCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::StartDBCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DocDBClient::StopDBCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DocDBClient::StopDBCluster, this, request, handler, context, m_executor.get());
}
