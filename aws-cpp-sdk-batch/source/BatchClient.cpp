...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::CancelJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::CancelJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::CreateComputeEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::CreateComputeEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::CreateJobQueue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::CreateJobQueue, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::CreateSchedulingPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::CreateSchedulingPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::DeleteComputeEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::DeleteComputeEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::DeleteJobQueue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::DeleteJobQueue, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::DeleteSchedulingPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::DeleteSchedulingPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::DeregisterJobDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::DeregisterJobDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::DescribeComputeEnvironments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::DescribeComputeEnvironments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::DescribeJobDefinitions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::DescribeJobDefinitions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::DescribeJobQueues, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::DescribeJobQueues, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::DescribeJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::DescribeJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::DescribeSchedulingPolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::DescribeSchedulingPolicies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::ListJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::ListJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::ListSchedulingPolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::ListSchedulingPolicies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::RegisterJobDefinition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::RegisterJobDefinition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::SubmitJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::SubmitJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::TerminateJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::TerminateJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::UpdateComputeEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::UpdateComputeEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::UpdateJobQueue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::UpdateJobQueue, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BatchClient::UpdateSchedulingPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BatchClient::UpdateSchedulingPolicy, this, request, handler, context, m_executor.get());
}
