...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::CreateHttpNamespace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::CreateHttpNamespace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::CreatePrivateDnsNamespace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::CreatePrivateDnsNamespace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::CreatePublicDnsNamespace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::CreatePublicDnsNamespace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::CreateService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::CreateService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::DeleteNamespace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::DeleteNamespace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::DeleteService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::DeleteService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::DeregisterInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::DeregisterInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::DiscoverInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::DiscoverInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::GetInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::GetInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::GetInstancesHealthStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::GetInstancesHealthStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::GetNamespace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::GetNamespace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::GetOperation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::GetOperation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::GetService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::GetService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::ListInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::ListInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::ListNamespaces, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::ListNamespaces, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::ListOperations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::ListOperations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::ListServices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::ListServices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::RegisterInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::RegisterInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::UpdateHttpNamespace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::UpdateHttpNamespace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::UpdateInstanceCustomHealthStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::UpdateInstanceCustomHealthStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::UpdatePrivateDnsNamespace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::UpdatePrivateDnsNamespace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::UpdatePublicDnsNamespace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::UpdatePublicDnsNamespace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceDiscoveryClient::UpdateService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceDiscoveryClient::UpdateService, this, request, handler, context, m_executor.get());
}
