...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ControlTowerClient::DisableControl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ControlTowerClient::DisableControl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ControlTowerClient::EnableControl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ControlTowerClient::EnableControl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ControlTowerClient::GetControlOperation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ControlTowerClient::GetControlOperation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ControlTowerClient::ListEnabledControls, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ControlTowerClient::ListEnabledControls, this, request, handler, context, m_executor.get());
}
