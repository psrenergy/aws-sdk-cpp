...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::BatchAssociateScramSecret, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::BatchAssociateScramSecret, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::CreateCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::CreateCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::CreateClusterV2, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::CreateClusterV2, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::CreateConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::CreateConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::DeleteCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::DeleteCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::DeleteConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::DeleteConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::DescribeCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::DescribeCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::DescribeClusterV2, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::DescribeClusterV2, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::DescribeClusterOperation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::DescribeClusterOperation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::DescribeConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::DescribeConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::DescribeConfigurationRevision, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::DescribeConfigurationRevision, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::BatchDisassociateScramSecret, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::BatchDisassociateScramSecret, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::GetBootstrapBrokers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::GetBootstrapBrokers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::GetCompatibleKafkaVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::GetCompatibleKafkaVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::ListClusterOperations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::ListClusterOperations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::ListClusters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::ListClusters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::ListClustersV2, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::ListClustersV2, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::ListConfigurationRevisions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::ListConfigurationRevisions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::ListConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::ListConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::ListKafkaVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::ListKafkaVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::ListNodes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::ListNodes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::ListScramSecrets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::ListScramSecrets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::RebootBroker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::RebootBroker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateBrokerCount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateBrokerCount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateBrokerType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateBrokerType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateBrokerStorage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateBrokerStorage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateConnectivity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateConnectivity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateClusterConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateClusterConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateClusterKafkaVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateClusterKafkaVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateMonitoring, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateMonitoring, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateSecurity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateSecurity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaClient::UpdateStorage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaClient::UpdateStorage, this, request, handler, context, m_executor.get());
}
