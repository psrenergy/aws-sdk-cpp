...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectContactLensClient::ListRealtimeContactAnalysisSegments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectContactLensClient::ListRealtimeContactAnalysisSegments, this, request, handler, context, m_executor.get());
}
