...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::AssociateLenses, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::AssociateLenses, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::CreateLensShare, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::CreateLensShare, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::CreateLensVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::CreateLensVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::CreateMilestone, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::CreateMilestone, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::CreateWorkload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::CreateWorkload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::CreateWorkloadShare, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::CreateWorkloadShare, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::DeleteLens, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::DeleteLens, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::DeleteLensShare, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::DeleteLensShare, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::DeleteWorkload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::DeleteWorkload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::DeleteWorkloadShare, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::DeleteWorkloadShare, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::DisassociateLenses, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::DisassociateLenses, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ExportLens, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ExportLens, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::GetAnswer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::GetAnswer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::GetLens, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::GetLens, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::GetLensReview, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::GetLensReview, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::GetLensReviewReport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::GetLensReviewReport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::GetLensVersionDifference, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::GetLensVersionDifference, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::GetMilestone, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::GetMilestone, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::GetWorkload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::GetWorkload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ImportLens, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ImportLens, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListAnswers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListAnswers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListCheckDetails, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListCheckDetails, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListCheckSummaries, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListCheckSummaries, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListLensReviewImprovements, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListLensReviewImprovements, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListLensReviews, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListLensReviews, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListLensShares, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListLensShares, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListLenses, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListLenses, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListMilestones, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListMilestones, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListNotifications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListNotifications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListShareInvitations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListShareInvitations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListWorkloadShares, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListWorkloadShares, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::ListWorkloads, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::ListWorkloads, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::UpdateAnswer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::UpdateAnswer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::UpdateGlobalSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::UpdateGlobalSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::UpdateLensReview, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::UpdateLensReview, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::UpdateShareInvitation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::UpdateShareInvitation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::UpdateWorkload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::UpdateWorkload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::UpdateWorkloadShare, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::UpdateWorkloadShare, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WellArchitectedClient::UpgradeLensReview, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WellArchitectedClient::UpgradeLensReview, this, request, handler, context, m_executor.get());
}
