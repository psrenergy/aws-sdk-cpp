...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::AcceptAdministratorInvitation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::AcceptAdministratorInvitation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::BatchDisableStandards, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::BatchDisableStandards, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::BatchEnableStandards, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::BatchEnableStandards, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::BatchImportFindings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::BatchImportFindings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::BatchUpdateFindings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::BatchUpdateFindings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::CreateActionTarget, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::CreateActionTarget, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::CreateFindingAggregator, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::CreateFindingAggregator, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::CreateInsight, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::CreateInsight, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::CreateMembers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::CreateMembers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DeclineInvitations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DeclineInvitations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DeleteActionTarget, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DeleteActionTarget, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DeleteFindingAggregator, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DeleteFindingAggregator, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DeleteInsight, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DeleteInsight, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DeleteInvitations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DeleteInvitations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DeleteMembers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DeleteMembers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DescribeActionTargets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DescribeActionTargets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DescribeHub, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DescribeHub, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DescribeOrganizationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DescribeOrganizationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DescribeProducts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DescribeProducts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DescribeStandards, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DescribeStandards, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DescribeStandardsControls, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DescribeStandardsControls, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DisableImportFindingsForProduct, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DisableImportFindingsForProduct, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DisableOrganizationAdminAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DisableOrganizationAdminAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DisableSecurityHub, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DisableSecurityHub, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DisassociateFromAdministratorAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DisassociateFromAdministratorAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::DisassociateMembers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::DisassociateMembers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::EnableImportFindingsForProduct, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::EnableImportFindingsForProduct, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::EnableOrganizationAdminAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::EnableOrganizationAdminAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::EnableSecurityHub, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::EnableSecurityHub, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::GetAdministratorAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::GetAdministratorAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::GetEnabledStandards, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::GetEnabledStandards, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::GetFindingAggregator, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::GetFindingAggregator, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::GetFindings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::GetFindings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::GetInsightResults, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::GetInsightResults, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::GetInsights, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::GetInsights, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::GetInvitationsCount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::GetInvitationsCount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::GetMembers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::GetMembers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::InviteMembers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::InviteMembers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::ListEnabledProductsForImport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::ListEnabledProductsForImport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::ListFindingAggregators, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::ListFindingAggregators, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::ListInvitations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::ListInvitations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::ListMembers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::ListMembers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::ListOrganizationAdminAccounts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::ListOrganizationAdminAccounts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::UpdateActionTarget, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::UpdateActionTarget, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::UpdateFindingAggregator, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::UpdateFindingAggregator, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::UpdateFindings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::UpdateFindings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::UpdateInsight, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::UpdateInsight, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::UpdateOrganizationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::UpdateOrganizationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::UpdateSecurityHubConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::UpdateSecurityHubConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecurityHubClient::UpdateStandardsControl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecurityHubClient::UpdateStandardsControl, this, request, handler, context, m_executor.get());
}
