...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EC2InstanceConnectClient::SendSSHPublicKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EC2InstanceConnectClient::SendSSHPublicKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EC2InstanceConnectClient::SendSerialConsoleSSHPublicKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EC2InstanceConnectClient::SendSerialConsoleSSHPublicKey, this, request, handler, context, m_executor.get());
}
