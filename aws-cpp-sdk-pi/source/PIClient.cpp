...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PIClient::DescribeDimensionKeys, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PIClient::DescribeDimensionKeys, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PIClient::GetDimensionKeyDetails, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PIClient::GetDimensionKeyDetails, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PIClient::GetResourceMetadata, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PIClient::GetResourceMetadata, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PIClient::GetResourceMetrics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PIClient::GetResourceMetrics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PIClient::ListAvailableResourceDimensions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PIClient::ListAvailableResourceDimensions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PIClient::ListAvailableResourceMetrics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PIClient::ListAvailableResourceMetrics, this, request, handler, context, m_executor.get());
}
