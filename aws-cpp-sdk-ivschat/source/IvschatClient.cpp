...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::CreateChatToken, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::CreateChatToken, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::CreateLoggingConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::CreateLoggingConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::CreateRoom, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::CreateRoom, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::DeleteLoggingConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::DeleteLoggingConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::DeleteMessage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::DeleteMessage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::DeleteRoom, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::DeleteRoom, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::DisconnectUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::DisconnectUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::GetLoggingConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::GetLoggingConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::GetRoom, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::GetRoom, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::ListLoggingConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::ListLoggingConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::ListRooms, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::ListRooms, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::SendEvent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::SendEvent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::UpdateLoggingConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::UpdateLoggingConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &IvschatClient::UpdateRoom, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&IvschatClient::UpdateRoom, this, request, handler, context, m_executor.get());
}
