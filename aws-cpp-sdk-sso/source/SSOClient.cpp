...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSOClient::GetRoleCredentials, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSOClient::GetRoleCredentials, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSOClient::ListAccountRoles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSOClient::ListAccountRoles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSOClient::ListAccounts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSOClient::ListAccounts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSOClient::Logout, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSOClient::Logout, this, request, handler, context, m_executor.get());
}
