...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::AddProfileKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::AddProfileKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::CreateDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::CreateDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::CreateIntegrationWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::CreateIntegrationWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::CreateProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::CreateProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::DeleteDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::DeleteDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::DeleteIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::DeleteIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::DeleteProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::DeleteProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::DeleteProfileKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::DeleteProfileKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::DeleteProfileObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::DeleteProfileObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::DeleteProfileObjectType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::DeleteProfileObjectType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::DeleteWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::DeleteWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::GetAutoMergingPreview, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::GetAutoMergingPreview, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::GetDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::GetDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::GetIdentityResolutionJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::GetIdentityResolutionJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::GetIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::GetIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::GetMatches, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::GetMatches, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::GetProfileObjectType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::GetProfileObjectType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::GetProfileObjectTypeTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::GetProfileObjectTypeTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::GetWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::GetWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::GetWorkflowSteps, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::GetWorkflowSteps, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::ListAccountIntegrations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::ListAccountIntegrations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::ListDomains, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::ListDomains, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::ListIdentityResolutionJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::ListIdentityResolutionJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::ListIntegrations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::ListIntegrations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::ListProfileObjectTypeTemplates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::ListProfileObjectTypeTemplates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::ListProfileObjectTypes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::ListProfileObjectTypes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::ListProfileObjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::ListProfileObjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::ListWorkflows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::ListWorkflows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::MergeProfiles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::MergeProfiles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::PutIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::PutIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::PutProfileObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::PutProfileObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::PutProfileObjectType, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::PutProfileObjectType, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::SearchProfiles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::SearchProfiles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::UpdateDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::UpdateDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CustomerProfilesClient::UpdateProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CustomerProfilesClient::UpdateProfile, this, request, handler, context, m_executor.get());
}
