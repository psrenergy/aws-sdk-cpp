...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoArchivedMediaClient::GetClip, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoArchivedMediaClient::GetClip, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoArchivedMediaClient::GetDASHStreamingSessionURL, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoArchivedMediaClient::GetDASHStreamingSessionURL, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoArchivedMediaClient::GetHLSStreamingSessionURL, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoArchivedMediaClient::GetHLSStreamingSessionURL, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoArchivedMediaClient::GetImages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoArchivedMediaClient::GetImages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoArchivedMediaClient::GetMediaForFragmentList, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoArchivedMediaClient::GetMediaForFragmentList, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KinesisVideoArchivedMediaClient::ListFragments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KinesisVideoArchivedMediaClient::ListFragments, this, request, handler, context, m_executor.get());
}
