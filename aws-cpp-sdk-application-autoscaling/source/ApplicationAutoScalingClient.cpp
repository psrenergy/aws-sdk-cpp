...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::DeleteScalingPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::DeleteScalingPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::DeleteScheduledAction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::DeleteScheduledAction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::DeregisterScalableTarget, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::DeregisterScalableTarget, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::DescribeScalableTargets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::DescribeScalableTargets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::DescribeScalingActivities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::DescribeScalingActivities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::DescribeScalingPolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::DescribeScalingPolicies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::DescribeScheduledActions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::DescribeScheduledActions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::PutScalingPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::PutScalingPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::PutScheduledAction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::PutScheduledAction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApplicationAutoScalingClient::RegisterScalableTarget, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApplicationAutoScalingClient::RegisterScalableTarget, this, request, handler, context, m_executor.get());
}
