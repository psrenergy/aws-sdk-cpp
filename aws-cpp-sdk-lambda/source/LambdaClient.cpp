...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::AddLayerVersionPermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::AddLayerVersionPermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::AddPermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::AddPermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::CreateAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::CreateAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::CreateCodeSigningConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::CreateCodeSigningConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::CreateEventSourceMapping, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::CreateEventSourceMapping, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::CreateFunction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::CreateFunction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::CreateFunctionUrlConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::CreateFunctionUrlConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteCodeSigningConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteCodeSigningConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteEventSourceMapping, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteEventSourceMapping, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteFunction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteFunction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteFunctionCodeSigningConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteFunctionCodeSigningConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteFunctionConcurrency, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteFunctionConcurrency, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteFunctionEventInvokeConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteFunctionEventInvokeConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteFunctionUrlConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteFunctionUrlConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteLayerVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteLayerVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::DeleteProvisionedConcurrencyConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::DeleteProvisionedConcurrencyConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetAccountSettings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetAccountSettings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetCodeSigningConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetCodeSigningConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetEventSourceMapping, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetEventSourceMapping, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetFunction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetFunction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetFunctionCodeSigningConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetFunctionCodeSigningConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetFunctionConcurrency, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetFunctionConcurrency, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetFunctionConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetFunctionConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetFunctionEventInvokeConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetFunctionEventInvokeConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetFunctionUrlConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetFunctionUrlConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetLayerVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetLayerVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetLayerVersionByArn, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetLayerVersionByArn, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetLayerVersionPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetLayerVersionPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::GetProvisionedConcurrencyConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::GetProvisionedConcurrencyConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::Invoke, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::Invoke, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListAliases, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListAliases, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListCodeSigningConfigs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListCodeSigningConfigs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListEventSourceMappings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListEventSourceMappings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListFunctionEventInvokeConfigs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListFunctionEventInvokeConfigs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListFunctionUrlConfigs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListFunctionUrlConfigs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListFunctions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListFunctions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListFunctionsByCodeSigningConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListFunctionsByCodeSigningConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListLayerVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListLayerVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListLayers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListLayers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListProvisionedConcurrencyConfigs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListProvisionedConcurrencyConfigs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListTags, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListTags, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::ListVersionsByFunction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::ListVersionsByFunction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::PublishLayerVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::PublishLayerVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::PublishVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::PublishVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::PutFunctionCodeSigningConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::PutFunctionCodeSigningConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::PutFunctionConcurrency, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::PutFunctionConcurrency, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::PutFunctionEventInvokeConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::PutFunctionEventInvokeConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::PutProvisionedConcurrencyConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::PutProvisionedConcurrencyConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::RemoveLayerVersionPermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::RemoveLayerVersionPermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::RemovePermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::RemovePermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::UpdateAlias, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::UpdateAlias, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::UpdateCodeSigningConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::UpdateCodeSigningConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::UpdateEventSourceMapping, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::UpdateEventSourceMapping, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::UpdateFunctionCode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::UpdateFunctionCode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::UpdateFunctionConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::UpdateFunctionConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::UpdateFunctionEventInvokeConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::UpdateFunctionEventInvokeConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LambdaClient::UpdateFunctionUrlConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LambdaClient::UpdateFunctionUrlConfig, this, request, handler, context, m_executor.get());
}
