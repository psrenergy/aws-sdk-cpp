...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::AssociateGatewayToServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::AssociateGatewayToServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::CreateGateway, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::CreateGateway, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::DeleteGateway, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::DeleteGateway, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::DeleteHypervisor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::DeleteHypervisor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::DisassociateGatewayFromServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::DisassociateGatewayFromServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::GetGateway, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::GetGateway, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::GetVirtualMachine, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::GetVirtualMachine, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::ImportHypervisorConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::ImportHypervisorConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::ListGateways, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::ListGateways, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::ListHypervisors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::ListHypervisors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::ListVirtualMachines, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::ListVirtualMachines, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::PutMaintenanceStartTime, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::PutMaintenanceStartTime, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::TestHypervisorConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::TestHypervisorConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::UpdateGatewayInformation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::UpdateGatewayInformation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::UpdateGatewaySoftwareNow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::UpdateGatewaySoftwareNow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &BackupGatewayClient::UpdateHypervisor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&BackupGatewayClient::UpdateHypervisor, this, request, handler, context, m_executor.get());
}
