...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::BatchGetField, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::BatchGetField, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::BatchPutFieldOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::BatchPutFieldOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::CreateCase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::CreateCase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::CreateDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::CreateDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::CreateField, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::CreateField, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::CreateLayout, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::CreateLayout, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::CreateRelatedItem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::CreateRelatedItem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::CreateTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::CreateTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::GetCase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::GetCase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::GetCaseEventConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::GetCaseEventConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::GetDomain, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::GetDomain, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::GetLayout, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::GetLayout, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::GetTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::GetTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::ListCasesForContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::ListCasesForContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::ListDomains, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::ListDomains, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::ListFieldOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::ListFieldOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::ListFields, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::ListFields, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::ListLayouts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::ListLayouts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::ListTemplates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::ListTemplates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::PutCaseEventConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::PutCaseEventConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::SearchCases, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::SearchCases, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::SearchRelatedItems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::SearchRelatedItems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::UpdateCase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::UpdateCase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::UpdateField, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::UpdateField, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::UpdateLayout, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::UpdateLayout, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectCasesClient::UpdateTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectCasesClient::UpdateTemplate, this, request, handler, context, m_executor.get());
}
