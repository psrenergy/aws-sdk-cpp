...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::CreateAccessor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::CreateAccessor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::CreateMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::CreateMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::CreateNetwork, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::CreateNetwork, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::CreateNode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::CreateNode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::CreateProposal, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::CreateProposal, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::DeleteAccessor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::DeleteAccessor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::DeleteMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::DeleteMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::DeleteNode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::DeleteNode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::GetAccessor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::GetAccessor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::GetMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::GetMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::GetNetwork, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::GetNetwork, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::GetNode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::GetNode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::GetProposal, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::GetProposal, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::ListAccessors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::ListAccessors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::ListInvitations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::ListInvitations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::ListMembers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::ListMembers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::ListNetworks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::ListNetworks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::ListNodes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::ListNodes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::ListProposalVotes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::ListProposalVotes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::ListProposals, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::ListProposals, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::RejectInvitation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::RejectInvitation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::UpdateMember, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::UpdateMember, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::UpdateNode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::UpdateNode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ManagedBlockchainClient::VoteOnProposal, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ManagedBlockchainClient::VoteOnProposal, this, request, handler, context, m_executor.get());
}
