...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DeleteAlarms, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DeleteAlarms, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DeleteAnomalyDetector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DeleteAnomalyDetector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DeleteDashboards, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DeleteDashboards, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DeleteInsightRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DeleteInsightRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DeleteMetricStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DeleteMetricStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DescribeAlarmHistory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DescribeAlarmHistory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DescribeAlarms, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DescribeAlarms, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DescribeAlarmsForMetric, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DescribeAlarmsForMetric, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DescribeAnomalyDetectors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DescribeAnomalyDetectors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DescribeInsightRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DescribeInsightRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DisableAlarmActions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DisableAlarmActions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::DisableInsightRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::DisableInsightRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::EnableAlarmActions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::EnableAlarmActions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::EnableInsightRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::EnableInsightRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::GetDashboard, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::GetDashboard, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::GetInsightRuleReport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::GetInsightRuleReport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::GetMetricData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::GetMetricData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::GetMetricStatistics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::GetMetricStatistics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::GetMetricStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::GetMetricStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::GetMetricWidgetImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::GetMetricWidgetImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::ListDashboards, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::ListDashboards, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::ListManagedInsightRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::ListManagedInsightRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::ListMetricStreams, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::ListMetricStreams, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::ListMetrics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::ListMetrics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::PutAnomalyDetector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::PutAnomalyDetector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::PutCompositeAlarm, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::PutCompositeAlarm, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::PutDashboard, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::PutDashboard, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::PutInsightRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::PutInsightRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::PutManagedInsightRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::PutManagedInsightRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::PutMetricAlarm, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::PutMetricAlarm, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::PutMetricData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::PutMetricData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::PutMetricStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::PutMetricStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::SetAlarmState, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::SetAlarmState, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::StartMetricStreams, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::StartMetricStreams, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::StopMetricStreams, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::StopMetricStreams, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &CloudWatchClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&CloudWatchClient::UntagResource, this, request, handler, context, m_executor.get());
}
