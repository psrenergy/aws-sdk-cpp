...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::AddFlowMediaStreams, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::AddFlowMediaStreams, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::AddFlowOutputs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::AddFlowOutputs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::AddFlowSources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::AddFlowSources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::AddFlowVpcInterfaces, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::AddFlowVpcInterfaces, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::CreateFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::CreateFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::DeleteFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::DeleteFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::DescribeFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::DescribeFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::DescribeOffering, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::DescribeOffering, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::DescribeReservation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::DescribeReservation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::GrantFlowEntitlements, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::GrantFlowEntitlements, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::ListEntitlements, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::ListEntitlements, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::ListFlows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::ListFlows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::ListOfferings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::ListOfferings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::ListReservations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::ListReservations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::PurchaseOffering, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::PurchaseOffering, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::RemoveFlowMediaStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::RemoveFlowMediaStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::RemoveFlowOutput, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::RemoveFlowOutput, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::RemoveFlowSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::RemoveFlowSource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::RemoveFlowVpcInterface, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::RemoveFlowVpcInterface, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::RevokeFlowEntitlement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::RevokeFlowEntitlement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::StartFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::StartFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::StopFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::StopFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::UpdateFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::UpdateFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::UpdateFlowEntitlement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::UpdateFlowEntitlement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::UpdateFlowMediaStream, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::UpdateFlowMediaStream, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::UpdateFlowOutput, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::UpdateFlowOutput, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MediaConnectClient::UpdateFlowSource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MediaConnectClient::UpdateFlowSource, this, request, handler, context, m_executor.get());
}
