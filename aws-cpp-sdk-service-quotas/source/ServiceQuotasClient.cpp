...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::AssociateServiceQuotaTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::AssociateServiceQuotaTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::DeleteServiceQuotaIncreaseRequestFromTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::DeleteServiceQuotaIncreaseRequestFromTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::DisassociateServiceQuotaTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::DisassociateServiceQuotaTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::GetAWSDefaultServiceQuota, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::GetAWSDefaultServiceQuota, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::GetAssociationForServiceQuotaTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::GetAssociationForServiceQuotaTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::GetRequestedServiceQuotaChange, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::GetRequestedServiceQuotaChange, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::GetServiceQuota, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::GetServiceQuota, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::GetServiceQuotaIncreaseRequestFromTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::GetServiceQuotaIncreaseRequestFromTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::ListAWSDefaultServiceQuotas, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::ListAWSDefaultServiceQuotas, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::ListRequestedServiceQuotaChangeHistory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::ListRequestedServiceQuotaChangeHistory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::ListRequestedServiceQuotaChangeHistoryByQuota, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::ListRequestedServiceQuotaChangeHistoryByQuota, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::ListServiceQuotaIncreaseRequestsInTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::ListServiceQuotaIncreaseRequestsInTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::ListServiceQuotas, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::ListServiceQuotas, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::ListServices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::ListServices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::PutServiceQuotaIncreaseRequestIntoTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::PutServiceQuotaIncreaseRequestIntoTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::RequestServiceQuotaIncrease, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::RequestServiceQuotaIncrease, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ServiceQuotasClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ServiceQuotasClient::UntagResource, this, request, handler, context, m_executor.get());
}
