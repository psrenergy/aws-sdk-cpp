...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::AddTagsToResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::AddTagsToResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::AuthorizeCacheSecurityGroupIngress, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::AuthorizeCacheSecurityGroupIngress, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::BatchApplyUpdateAction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::BatchApplyUpdateAction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::BatchStopUpdateAction, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::BatchStopUpdateAction, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CompleteMigration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CompleteMigration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CopySnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CopySnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CreateCacheCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CreateCacheCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CreateCacheParameterGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CreateCacheParameterGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CreateCacheSecurityGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CreateCacheSecurityGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CreateCacheSubnetGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CreateCacheSubnetGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CreateGlobalReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CreateGlobalReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CreateReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CreateReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CreateSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CreateSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CreateUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CreateUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::CreateUserGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::CreateUserGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DecreaseNodeGroupsInGlobalReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DecreaseNodeGroupsInGlobalReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DecreaseReplicaCount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DecreaseReplicaCount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DeleteCacheCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DeleteCacheCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DeleteCacheParameterGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DeleteCacheParameterGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DeleteCacheSecurityGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DeleteCacheSecurityGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DeleteCacheSubnetGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DeleteCacheSubnetGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DeleteGlobalReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DeleteGlobalReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DeleteReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DeleteReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DeleteSnapshot, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DeleteSnapshot, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DeleteUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DeleteUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DeleteUserGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DeleteUserGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeCacheClusters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeCacheClusters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeCacheEngineVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeCacheEngineVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeCacheParameterGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeCacheParameterGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeCacheParameters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeCacheParameters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeCacheSecurityGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeCacheSecurityGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeCacheSubnetGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeCacheSubnetGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeEngineDefaultParameters, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeEngineDefaultParameters, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeEvents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeEvents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeGlobalReplicationGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeGlobalReplicationGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeReplicationGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeReplicationGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeReservedCacheNodes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeReservedCacheNodes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeReservedCacheNodesOfferings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeReservedCacheNodesOfferings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeServiceUpdates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeServiceUpdates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeSnapshots, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeSnapshots, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeUpdateActions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeUpdateActions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeUserGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeUserGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DescribeUsers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DescribeUsers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::DisassociateGlobalReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::DisassociateGlobalReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::FailoverGlobalReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::FailoverGlobalReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::IncreaseNodeGroupsInGlobalReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::IncreaseNodeGroupsInGlobalReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::IncreaseReplicaCount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::IncreaseReplicaCount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ListAllowedNodeTypeModifications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ListAllowedNodeTypeModifications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ModifyCacheCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ModifyCacheCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ModifyCacheParameterGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ModifyCacheParameterGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ModifyCacheSubnetGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ModifyCacheSubnetGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ModifyGlobalReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ModifyGlobalReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ModifyReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ModifyReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ModifyReplicationGroupShardConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ModifyReplicationGroupShardConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ModifyUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ModifyUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ModifyUserGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ModifyUserGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::PurchaseReservedCacheNodesOffering, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::PurchaseReservedCacheNodesOffering, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::RebalanceSlotsInGlobalReplicationGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::RebalanceSlotsInGlobalReplicationGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::RebootCacheCluster, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::RebootCacheCluster, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::RemoveTagsFromResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::RemoveTagsFromResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::ResetCacheParameterGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::ResetCacheParameterGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::RevokeCacheSecurityGroupIngress, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::RevokeCacheSecurityGroupIngress, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::StartMigration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::StartMigration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ElastiCacheClient::TestFailover, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ElastiCacheClient::TestFailover, this, request, handler, context, m_executor.get());
}
