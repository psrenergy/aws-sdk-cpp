...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::CancelImageCreation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::CancelImageCreation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::CreateComponent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::CreateComponent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::CreateContainerRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::CreateContainerRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::CreateDistributionConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::CreateDistributionConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::CreateImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::CreateImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::CreateImagePipeline, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::CreateImagePipeline, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::CreateImageRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::CreateImageRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::CreateInfrastructureConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::CreateInfrastructureConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::DeleteComponent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::DeleteComponent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::DeleteContainerRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::DeleteContainerRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::DeleteDistributionConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::DeleteDistributionConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::DeleteImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::DeleteImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::DeleteImagePipeline, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::DeleteImagePipeline, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::DeleteImageRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::DeleteImageRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::DeleteInfrastructureConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::DeleteInfrastructureConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetComponent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetComponent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetComponentPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetComponentPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetContainerRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetContainerRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetContainerRecipePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetContainerRecipePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetDistributionConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetDistributionConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetImagePipeline, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetImagePipeline, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetImagePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetImagePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetImageRecipe, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetImageRecipe, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetImageRecipePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetImageRecipePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::GetInfrastructureConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::GetInfrastructureConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ImportComponent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ImportComponent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ImportVmImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ImportVmImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListComponentBuildVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListComponentBuildVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListComponents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListComponents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListContainerRecipes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListContainerRecipes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListDistributionConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListDistributionConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListImageBuildVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListImageBuildVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListImagePackages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListImagePackages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListImagePipelineImages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListImagePipelineImages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListImagePipelines, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListImagePipelines, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListImageRecipes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListImageRecipes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListImages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListImages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListInfrastructureConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListInfrastructureConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::PutComponentPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::PutComponentPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::PutContainerRecipePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::PutContainerRecipePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::PutImagePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::PutImagePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::PutImageRecipePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::PutImageRecipePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::StartImagePipelineExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::StartImagePipelineExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::UpdateDistributionConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::UpdateDistributionConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::UpdateImagePipeline, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::UpdateImagePipeline, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImagebuilderClient::UpdateInfrastructureConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImagebuilderClient::UpdateInfrastructureConfiguration, this, request, handler, context, m_executor.get());
}
