...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::AcceptPage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::AcceptPage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::ActivateContactChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::ActivateContactChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::CreateContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::CreateContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::CreateContactChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::CreateContactChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::DeactivateContactChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::DeactivateContactChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::DeleteContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::DeleteContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::DeleteContactChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::DeleteContactChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::DescribeEngagement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::DescribeEngagement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::DescribePage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::DescribePage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::GetContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::GetContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::GetContactChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::GetContactChannel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::GetContactPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::GetContactPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::ListContactChannels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::ListContactChannels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::ListContacts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::ListContacts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::ListEngagements, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::ListEngagements, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::ListPageReceipts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::ListPageReceipts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::ListPagesByContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::ListPagesByContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::ListPagesByEngagement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::ListPagesByEngagement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::PutContactPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::PutContactPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::SendActivationCode, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::SendActivationCode, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::StartEngagement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::StartEngagement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::StopEngagement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::StopEngagement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::UpdateContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::UpdateContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMContactsClient::UpdateContactChannel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMContactsClient::UpdateContactChannel, this, request, handler, context, m_executor.get());
}
