...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::CreateExtendedSourceServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::CreateExtendedSourceServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::CreateReplicationConfigurationTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::CreateReplicationConfigurationTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DeleteJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DeleteJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DeleteRecoveryInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DeleteRecoveryInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DeleteReplicationConfigurationTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DeleteReplicationConfigurationTemplate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DeleteSourceServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DeleteSourceServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DescribeJobLogItems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DescribeJobLogItems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DescribeJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DescribeJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DescribeRecoveryInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DescribeRecoveryInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DescribeRecoverySnapshots, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DescribeRecoverySnapshots, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DescribeReplicationConfigurationTemplates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DescribeReplicationConfigurationTemplates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DescribeSourceServers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DescribeSourceServers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DisconnectRecoveryInstance, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DisconnectRecoveryInstance, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::DisconnectSourceServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::DisconnectSourceServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::GetFailbackReplicationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::GetFailbackReplicationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::GetLaunchConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::GetLaunchConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::GetReplicationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::GetReplicationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::InitializeService, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::InitializeService, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::ListExtensibleSourceServers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::ListExtensibleSourceServers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::ListStagingAccounts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::ListStagingAccounts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::RetryDataReplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::RetryDataReplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::StartFailbackLaunch, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::StartFailbackLaunch, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::StartRecovery, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::StartRecovery, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::StopFailback, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::StopFailback, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::TerminateRecoveryInstances, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::TerminateRecoveryInstances, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::UpdateFailbackReplicationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::UpdateFailbackReplicationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::UpdateLaunchConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::UpdateLaunchConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::UpdateReplicationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::UpdateReplicationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &DrsClient::UpdateReplicationConfigurationTemplate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&DrsClient::UpdateReplicationConfigurationTemplate, this, request, handler, context, m_executor.get());
}
