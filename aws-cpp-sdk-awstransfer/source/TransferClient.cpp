...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::CreateAccess, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::CreateAccess, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::CreateAgreement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::CreateAgreement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::CreateConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::CreateConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::CreateProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::CreateProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::CreateServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::CreateServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::CreateUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::CreateUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::CreateWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::CreateWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteAccess, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteAccess, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteAgreement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteAgreement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteHostKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteHostKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteSshPublicKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteSshPublicKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DeleteWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DeleteWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeAccess, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeAccess, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeAgreement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeAgreement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeHostKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeHostKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeSecurityPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeSecurityPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::DescribeWorkflow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::DescribeWorkflow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ImportCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ImportCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ImportHostKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ImportHostKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ImportSshPublicKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ImportSshPublicKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListAccesses, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListAccesses, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListAgreements, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListAgreements, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListCertificates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListCertificates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListConnectors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListConnectors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListExecutions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListExecutions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListHostKeys, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListHostKeys, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListProfiles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListProfiles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListSecurityPolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListSecurityPolicies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListServers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListServers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListUsers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListUsers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::ListWorkflows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::ListWorkflows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::SendWorkflowStepState, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::SendWorkflowStepState, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::StartFileTransfer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::StartFileTransfer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::StartServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::StartServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::StopServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::StopServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::TestIdentityProvider, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::TestIdentityProvider, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::UpdateAccess, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::UpdateAccess, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::UpdateAgreement, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::UpdateAgreement, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::UpdateCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::UpdateCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::UpdateConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::UpdateConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::UpdateHostKey, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::UpdateHostKey, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::UpdateProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::UpdateProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::UpdateServer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::UpdateServer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &TransferClient::UpdateUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&TransferClient::UpdateUser, this, request, handler, context, m_executor.get());
}
