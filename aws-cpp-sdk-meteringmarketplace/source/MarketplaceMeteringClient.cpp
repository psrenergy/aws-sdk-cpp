...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceMeteringClient::BatchMeterUsage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceMeteringClient::BatchMeterUsage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceMeteringClient::MeterUsage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceMeteringClient::MeterUsage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceMeteringClient::RegisterUsage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceMeteringClient::RegisterUsage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &MarketplaceMeteringClient::ResolveCustomer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&MarketplaceMeteringClient::ResolveCustomer, this, request, handler, context, m_executor.get());
}
