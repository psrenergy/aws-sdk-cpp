...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::AddAttachmentsToSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::AddAttachmentsToSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::AddCommunicationToCase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::AddCommunicationToCase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::CreateCase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::CreateCase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::DescribeAttachment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::DescribeAttachment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::DescribeCases, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::DescribeCases, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::DescribeCommunications, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::DescribeCommunications, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::DescribeServices, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::DescribeServices, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::DescribeSeverityLevels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::DescribeSeverityLevels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::DescribeTrustedAdvisorCheckRefreshStatuses, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::DescribeTrustedAdvisorCheckRefreshStatuses, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::DescribeTrustedAdvisorCheckResult, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::DescribeTrustedAdvisorCheckResult, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::DescribeTrustedAdvisorCheckSummaries, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::DescribeTrustedAdvisorCheckSummaries, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::DescribeTrustedAdvisorChecks, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::DescribeTrustedAdvisorChecks, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::RefreshTrustedAdvisorCheck, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::RefreshTrustedAdvisorCheck, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SupportClient::ResolveCase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SupportClient::ResolveCase, this, request, handler, context, m_executor.get());
}
