...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppConfigDataClient::GetLatestConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppConfigDataClient::GetLatestConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppConfigDataClient::StartConfigurationSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppConfigDataClient::StartConfigurationSession, this, request, handler, context, m_executor.get());
}
