...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayManagementApiClient::DeleteConnection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayManagementApiClient::DeleteConnection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayManagementApiClient::GetConnection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayManagementApiClient::GetConnection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ApiGatewayManagementApiClient::PostToConnection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ApiGatewayManagementApiClient::PostToConnection, this, request, handler, context, m_executor.get());
}
