...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSOOIDCClient::CreateToken, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSOOIDCClient::CreateToken, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSOOIDCClient::RegisterClient, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSOOIDCClient::RegisterClient, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSOOIDCClient::StartDeviceAuthorization, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSOOIDCClient::StartDeviceAuthorization, this, request, handler, context, m_executor.get());
}
