...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::DeleteRecommendationPreferences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::DeleteRecommendationPreferences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::DescribeRecommendationExportJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::DescribeRecommendationExportJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::ExportAutoScalingGroupRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::ExportAutoScalingGroupRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::ExportEBSVolumeRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::ExportEBSVolumeRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::ExportEC2InstanceRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::ExportEC2InstanceRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::ExportLambdaFunctionRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::ExportLambdaFunctionRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetAutoScalingGroupRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetAutoScalingGroupRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetEBSVolumeRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetEBSVolumeRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetEC2InstanceRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetEC2InstanceRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetEC2RecommendationProjectedMetrics, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetEC2RecommendationProjectedMetrics, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetEffectiveRecommendationPreferences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetEffectiveRecommendationPreferences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetEnrollmentStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetEnrollmentStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetEnrollmentStatusesForOrganization, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetEnrollmentStatusesForOrganization, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetLambdaFunctionRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetLambdaFunctionRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetRecommendationPreferences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetRecommendationPreferences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::GetRecommendationSummaries, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::GetRecommendationSummaries, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::PutRecommendationPreferences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::PutRecommendationPreferences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ComputeOptimizerClient::UpdateEnrollmentStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ComputeOptimizerClient::UpdateEnrollmentStatus, this, request, handler, context, m_executor.get());
}
