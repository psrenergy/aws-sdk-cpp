...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::CreateAccessPoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::CreateAccessPoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::CreateAccessPointForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::CreateAccessPointForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::CreateBucket, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::CreateBucket, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::CreateJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::CreateJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::CreateMultiRegionAccessPoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::CreateMultiRegionAccessPoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteAccessPoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteAccessPoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteAccessPointForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteAccessPointForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteAccessPointPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteAccessPointPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteAccessPointPolicyForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteAccessPointPolicyForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteBucket, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteBucket, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteBucketLifecycleConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteBucketLifecycleConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteBucketPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteBucketPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteBucketTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteBucketTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteJobTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteJobTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteMultiRegionAccessPoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteMultiRegionAccessPoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeletePublicAccessBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeletePublicAccessBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteStorageLensConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteStorageLensConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DeleteStorageLensConfigurationTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DeleteStorageLensConfigurationTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DescribeJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DescribeJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::DescribeMultiRegionAccessPointOperation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::DescribeMultiRegionAccessPointOperation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetAccessPoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetAccessPoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetAccessPointConfigurationForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetAccessPointConfigurationForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetAccessPointForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetAccessPointForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetAccessPointPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetAccessPointPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetAccessPointPolicyForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetAccessPointPolicyForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetAccessPointPolicyStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetAccessPointPolicyStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetAccessPointPolicyStatusForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetAccessPointPolicyStatusForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetBucket, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetBucket, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetBucketLifecycleConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetBucketLifecycleConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetBucketPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetBucketPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetBucketTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetBucketTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetBucketVersioning, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetBucketVersioning, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetJobTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetJobTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetMultiRegionAccessPoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetMultiRegionAccessPoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetMultiRegionAccessPointPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetMultiRegionAccessPointPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetMultiRegionAccessPointPolicyStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetMultiRegionAccessPointPolicyStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetPublicAccessBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetPublicAccessBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetStorageLensConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetStorageLensConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::GetStorageLensConfigurationTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::GetStorageLensConfigurationTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::ListAccessPoints, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::ListAccessPoints, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::ListAccessPointsForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::ListAccessPointsForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::ListJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::ListJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::ListMultiRegionAccessPoints, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::ListMultiRegionAccessPoints, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::ListRegionalBuckets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::ListRegionalBuckets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::ListStorageLensConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::ListStorageLensConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutAccessPointConfigurationForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutAccessPointConfigurationForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutAccessPointPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutAccessPointPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutAccessPointPolicyForObjectLambda, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutAccessPointPolicyForObjectLambda, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutBucketLifecycleConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutBucketLifecycleConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutBucketPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutBucketPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutBucketTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutBucketTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutBucketVersioning, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutBucketVersioning, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutJobTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutJobTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutMultiRegionAccessPointPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutMultiRegionAccessPointPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutPublicAccessBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutPublicAccessBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutStorageLensConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutStorageLensConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::PutStorageLensConfigurationTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::PutStorageLensConfigurationTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::UpdateJobPriority, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::UpdateJobPriority, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3ControlClient::UpdateJobStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3ControlClient::UpdateJobStatus, this, request, handler, context, m_executor.get());
}
