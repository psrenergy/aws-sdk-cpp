...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AutoScalingPlansClient::CreateScalingPlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AutoScalingPlansClient::CreateScalingPlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AutoScalingPlansClient::DeleteScalingPlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AutoScalingPlansClient::DeleteScalingPlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AutoScalingPlansClient::DescribeScalingPlanResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AutoScalingPlansClient::DescribeScalingPlanResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AutoScalingPlansClient::DescribeScalingPlans, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AutoScalingPlansClient::DescribeScalingPlans, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AutoScalingPlansClient::GetScalingPlanResourceForecastData, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AutoScalingPlansClient::GetScalingPlanResourceForecastData, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AutoScalingPlansClient::UpdateScalingPlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AutoScalingPlansClient::UpdateScalingPlan, this, request, handler, context, m_executor.get());
}
