...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::CreateAccessPoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::CreateAccessPoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::CreateFileSystem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::CreateFileSystem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::CreateMountTarget, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::CreateMountTarget, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::CreateReplicationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::CreateReplicationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DeleteAccessPoint, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DeleteAccessPoint, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DeleteFileSystem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DeleteFileSystem, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DeleteFileSystemPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DeleteFileSystemPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DeleteMountTarget, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DeleteMountTarget, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DeleteReplicationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DeleteReplicationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DescribeAccessPoints, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DescribeAccessPoints, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DescribeAccountPreferences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DescribeAccountPreferences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DescribeBackupPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DescribeBackupPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DescribeFileSystemPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DescribeFileSystemPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DescribeFileSystems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DescribeFileSystems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DescribeLifecycleConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DescribeLifecycleConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DescribeMountTargetSecurityGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DescribeMountTargetSecurityGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DescribeMountTargets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DescribeMountTargets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::DescribeReplicationConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::DescribeReplicationConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::ModifyMountTargetSecurityGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::ModifyMountTargetSecurityGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::PutAccountPreferences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::PutAccountPreferences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::PutBackupPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::PutBackupPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::PutFileSystemPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::PutFileSystemPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::PutLifecycleConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::PutLifecycleConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &EFSClient::UpdateFileSystem, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&EFSClient::UpdateFileSystem, this, request, handler, context, m_executor.get());
}
