...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ResourceGroupsTaggingAPIClient::DescribeReportCreation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ResourceGroupsTaggingAPIClient::DescribeReportCreation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ResourceGroupsTaggingAPIClient::GetComplianceSummary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ResourceGroupsTaggingAPIClient::GetComplianceSummary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ResourceGroupsTaggingAPIClient::GetResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ResourceGroupsTaggingAPIClient::GetResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ResourceGroupsTaggingAPIClient::GetTagKeys, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ResourceGroupsTaggingAPIClient::GetTagKeys, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ResourceGroupsTaggingAPIClient::GetTagValues, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ResourceGroupsTaggingAPIClient::GetTagValues, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ResourceGroupsTaggingAPIClient::StartReportCreation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ResourceGroupsTaggingAPIClient::StartReportCreation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ResourceGroupsTaggingAPIClient::TagResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ResourceGroupsTaggingAPIClient::TagResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ResourceGroupsTaggingAPIClient::UntagResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ResourceGroupsTaggingAPIClient::UntagResources, this, request, handler, context, m_executor.get());
}
