...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::CreateProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::CreateProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::CreateTrustAnchor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::CreateTrustAnchor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::DeleteCrl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::DeleteCrl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::DeleteProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::DeleteProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::DeleteTrustAnchor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::DeleteTrustAnchor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::DisableCrl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::DisableCrl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::DisableProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::DisableProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::DisableTrustAnchor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::DisableTrustAnchor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::EnableCrl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::EnableCrl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::EnableProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::EnableProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::EnableTrustAnchor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::EnableTrustAnchor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::GetCrl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::GetCrl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::GetProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::GetProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::GetSubject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::GetSubject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::GetTrustAnchor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::GetTrustAnchor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::ImportCrl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::ImportCrl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::ListCrls, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::ListCrls, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::ListProfiles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::ListProfiles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::ListSubjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::ListSubjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::ListTrustAnchors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::ListTrustAnchors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::UpdateCrl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::UpdateCrl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::UpdateProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::UpdateProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &RolesAnywhereClient::UpdateTrustAnchor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&RolesAnywhereClient::UpdateTrustAnchor, this, request, handler, context, m_executor.get());
}
