...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::CreateEnvironmentEC2, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::CreateEnvironmentEC2, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::CreateEnvironmentMembership, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::CreateEnvironmentMembership, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::DeleteEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::DeleteEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::DeleteEnvironmentMembership, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::DeleteEnvironmentMembership, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::DescribeEnvironmentMemberships, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::DescribeEnvironmentMemberships, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::DescribeEnvironmentStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::DescribeEnvironmentStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::DescribeEnvironments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::DescribeEnvironments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::ListEnvironments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::ListEnvironments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::UpdateEnvironment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::UpdateEnvironment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &Cloud9Client::UpdateEnvironmentMembership, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&Cloud9Client::UpdateEnvironmentMembership, this, request, handler, context, m_executor.get());
}
