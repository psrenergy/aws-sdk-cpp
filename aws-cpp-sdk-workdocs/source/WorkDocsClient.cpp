...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::AbortDocumentVersionUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::AbortDocumentVersionUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::ActivateUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::ActivateUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::AddResourcePermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::AddResourcePermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::CreateComment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::CreateComment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::CreateCustomMetadata, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::CreateCustomMetadata, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::CreateFolder, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::CreateFolder, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::CreateLabels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::CreateLabels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::CreateNotificationSubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::CreateNotificationSubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::CreateUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::CreateUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeactivateUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeactivateUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeleteComment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeleteComment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeleteCustomMetadata, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeleteCustomMetadata, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeleteDocument, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeleteDocument, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeleteDocumentVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeleteDocumentVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeleteFolder, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeleteFolder, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeleteFolderContents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeleteFolderContents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeleteLabels, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeleteLabels, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeleteNotificationSubscription, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeleteNotificationSubscription, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DeleteUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DeleteUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DescribeActivities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DescribeActivities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DescribeComments, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DescribeComments, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DescribeDocumentVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DescribeDocumentVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DescribeFolderContents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DescribeFolderContents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DescribeGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DescribeGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DescribeNotificationSubscriptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DescribeNotificationSubscriptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DescribeResourcePermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DescribeResourcePermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DescribeRootFolders, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DescribeRootFolders, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::DescribeUsers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::DescribeUsers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::GetCurrentUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::GetCurrentUser, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::GetDocument, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::GetDocument, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::GetDocumentPath, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::GetDocumentPath, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::GetDocumentVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::GetDocumentVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::GetFolder, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::GetFolder, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::GetFolderPath, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::GetFolderPath, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::GetResources, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::GetResources, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::InitiateDocumentVersionUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::InitiateDocumentVersionUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::RemoveAllResourcePermissions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::RemoveAllResourcePermissions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::RemoveResourcePermission, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::RemoveResourcePermission, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::RestoreDocumentVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::RestoreDocumentVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::UpdateDocument, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::UpdateDocument, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::UpdateDocumentVersion, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::UpdateDocumentVersion, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::UpdateFolder, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::UpdateFolder, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &WorkDocsClient::UpdateUser, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&WorkDocsClient::UpdateUser, this, request, handler, context, m_executor.get());
}
