...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PersonalizeRuntimeClient::GetPersonalizedRanking, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PersonalizeRuntimeClient::GetPersonalizedRanking, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PersonalizeRuntimeClient::GetRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PersonalizeRuntimeClient::GetRecommendations, this, request, handler, context, m_executor.get());
}
