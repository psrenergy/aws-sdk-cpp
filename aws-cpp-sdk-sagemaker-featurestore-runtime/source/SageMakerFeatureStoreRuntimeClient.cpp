...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SageMakerFeatureStoreRuntimeClient::BatchGetRecord, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SageMakerFeatureStoreRuntimeClient::BatchGetRecord, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SageMakerFeatureStoreRuntimeClient::DeleteRecord, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SageMakerFeatureStoreRuntimeClient::DeleteRecord, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SageMakerFeatureStoreRuntimeClient::GetRecord, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SageMakerFeatureStoreRuntimeClient::GetRecord, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SageMakerFeatureStoreRuntimeClient::PutRecord, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SageMakerFeatureStoreRuntimeClient::PutRecord, this, request, handler, context, m_executor.get());
}
