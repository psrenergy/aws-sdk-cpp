...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImportExportClient::CancelJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImportExportClient::CancelJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImportExportClient::CreateJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImportExportClient::CreateJob, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImportExportClient::GetShippingLabel, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImportExportClient::GetShippingLabel, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImportExportClient::GetStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImportExportClient::GetStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImportExportClient::ListJobs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImportExportClient::ListJobs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ImportExportClient::UpdateJob, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ImportExportClient::UpdateJob, this, request, handler, context, m_executor.get());
}
