...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::CreateReplicationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::CreateReplicationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::CreateResponsePlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::CreateResponsePlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::CreateTimelineEvent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::CreateTimelineEvent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::DeleteIncidentRecord, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::DeleteIncidentRecord, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::DeleteReplicationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::DeleteReplicationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::DeleteResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::DeleteResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::DeleteResponsePlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::DeleteResponsePlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::DeleteTimelineEvent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::DeleteTimelineEvent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::GetIncidentRecord, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::GetIncidentRecord, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::GetReplicationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::GetReplicationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::GetResourcePolicies, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::GetResourcePolicies, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::GetResponsePlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::GetResponsePlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::GetTimelineEvent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::GetTimelineEvent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::ListIncidentRecords, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::ListIncidentRecords, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::ListRelatedItems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::ListRelatedItems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::ListReplicationSets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::ListReplicationSets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::ListResponsePlans, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::ListResponsePlans, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::ListTimelineEvents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::ListTimelineEvents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::PutResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::PutResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::StartIncident, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::StartIncident, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::UpdateDeletionProtection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::UpdateDeletionProtection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::UpdateIncidentRecord, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::UpdateIncidentRecord, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::UpdateRelatedItems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::UpdateRelatedItems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::UpdateReplicationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::UpdateReplicationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::UpdateResponsePlan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::UpdateResponsePlan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SSMIncidentsClient::UpdateTimelineEvent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SSMIncidentsClient::UpdateTimelineEvent, this, request, handler, context, m_executor.get());
}
