...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::CreateConfigurationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::CreateConfigurationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::CreateConfigurationSetEventDestination, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::CreateConfigurationSetEventDestination, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::CreateDedicatedIpPool, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::CreateDedicatedIpPool, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::CreateDeliverabilityTestReport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::CreateDeliverabilityTestReport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::CreateEmailIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::CreateEmailIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::DeleteConfigurationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::DeleteConfigurationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::DeleteConfigurationSetEventDestination, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::DeleteConfigurationSetEventDestination, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::DeleteDedicatedIpPool, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::DeleteDedicatedIpPool, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::DeleteEmailIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::DeleteEmailIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetAccount, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetAccount, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetBlacklistReports, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetBlacklistReports, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetConfigurationSet, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetConfigurationSet, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetConfigurationSetEventDestinations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetConfigurationSetEventDestinations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetDedicatedIp, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetDedicatedIp, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetDedicatedIps, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetDedicatedIps, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetDeliverabilityDashboardOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetDeliverabilityDashboardOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetDeliverabilityTestReport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetDeliverabilityTestReport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetDomainDeliverabilityCampaign, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetDomainDeliverabilityCampaign, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetDomainStatisticsReport, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetDomainStatisticsReport, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::GetEmailIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::GetEmailIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::ListConfigurationSets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::ListConfigurationSets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::ListDedicatedIpPools, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::ListDedicatedIpPools, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::ListDeliverabilityTestReports, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::ListDeliverabilityTestReports, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::ListDomainDeliverabilityCampaigns, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::ListDomainDeliverabilityCampaigns, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::ListEmailIdentities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::ListEmailIdentities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutAccountDedicatedIpWarmupAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutAccountDedicatedIpWarmupAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutAccountSendingAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutAccountSendingAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutConfigurationSetDeliveryOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutConfigurationSetDeliveryOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutConfigurationSetReputationOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutConfigurationSetReputationOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutConfigurationSetSendingOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutConfigurationSetSendingOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutConfigurationSetTrackingOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutConfigurationSetTrackingOptions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutDedicatedIpInPool, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutDedicatedIpInPool, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutDedicatedIpWarmupAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutDedicatedIpWarmupAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutDeliverabilityDashboardOption, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutDeliverabilityDashboardOption, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutEmailIdentityDkimAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutEmailIdentityDkimAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutEmailIdentityFeedbackAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutEmailIdentityFeedbackAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::PutEmailIdentityMailFromAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::PutEmailIdentityMailFromAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::SendEmail, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::SendEmail, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PinpointEmailClient::UpdateConfigurationSetEventDestination, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PinpointEmailClient::UpdateConfigurationSetEventDestination, this, request, handler, context, m_executor.get());
}
