...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::CancelContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::CancelContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::CreateConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::CreateConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::CreateDataflowEndpointGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::CreateDataflowEndpointGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::CreateEphemeris, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::CreateEphemeris, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::CreateMissionProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::CreateMissionProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::DeleteConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::DeleteConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::DeleteDataflowEndpointGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::DeleteDataflowEndpointGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::DeleteEphemeris, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::DeleteEphemeris, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::DeleteMissionProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::DeleteMissionProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::DescribeContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::DescribeContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::DescribeEphemeris, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::DescribeEphemeris, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::GetConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::GetConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::GetDataflowEndpointGroup, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::GetDataflowEndpointGroup, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::GetMinuteUsage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::GetMinuteUsage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::GetMissionProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::GetMissionProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::GetSatellite, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::GetSatellite, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::ListConfigs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::ListConfigs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::ListContacts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::ListContacts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::ListDataflowEndpointGroups, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::ListDataflowEndpointGroups, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::ListEphemerides, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::ListEphemerides, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::ListGroundStations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::ListGroundStations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::ListMissionProfiles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::ListMissionProfiles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::ListSatellites, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::ListSatellites, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::ReserveContact, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::ReserveContact, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::UpdateConfig, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::UpdateConfig, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::UpdateEphemeris, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::UpdateEphemeris, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &GroundStationClient::UpdateMissionProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&GroundStationClient::UpdateMissionProfile, this, request, handler, context, m_executor.get());
}
