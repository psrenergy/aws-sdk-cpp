...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::CreateAssistant, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::CreateAssistant, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::CreateAssistantAssociation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::CreateAssistantAssociation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::CreateContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::CreateContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::CreateKnowledgeBase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::CreateKnowledgeBase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::CreateSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::CreateSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::DeleteAssistant, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::DeleteAssistant, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::DeleteAssistantAssociation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::DeleteAssistantAssociation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::DeleteContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::DeleteContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::DeleteKnowledgeBase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::DeleteKnowledgeBase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::GetAssistant, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::GetAssistant, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::GetAssistantAssociation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::GetAssistantAssociation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::GetContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::GetContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::GetContentSummary, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::GetContentSummary, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::GetKnowledgeBase, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::GetKnowledgeBase, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::GetRecommendations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::GetRecommendations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::GetSession, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::GetSession, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::ListAssistantAssociations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::ListAssistantAssociations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::ListAssistants, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::ListAssistants, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::ListContents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::ListContents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::ListKnowledgeBases, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::ListKnowledgeBases, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::NotifyRecommendationsReceived, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::NotifyRecommendationsReceived, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::QueryAssistant, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::QueryAssistant, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::RemoveKnowledgeBaseTemplateUri, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::RemoveKnowledgeBaseTemplateUri, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::SearchContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::SearchContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::SearchSessions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::SearchSessions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::StartContentUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::StartContentUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::UpdateContent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::UpdateContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ConnectWisdomServiceClient::UpdateKnowledgeBaseTemplateUri, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ConnectWisdomServiceClient::UpdateKnowledgeBaseTemplateUri, this, request, handler, context, m_executor.get());
}
