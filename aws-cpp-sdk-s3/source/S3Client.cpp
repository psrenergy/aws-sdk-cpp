...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::AbortMultipartUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::AbortMultipartUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::CompleteMultipartUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::CompleteMultipartUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::CopyObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::CopyObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::CreateBucket, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::CreateBucket, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::CreateMultipartUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::CreateMultipartUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucket, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucket, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketAnalyticsConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketAnalyticsConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketCors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketCors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketEncryption, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketEncryption, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketIntelligentTieringConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketIntelligentTieringConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketInventoryConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketInventoryConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketLifecycle, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketLifecycle, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketMetricsConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketMetricsConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketOwnershipControls, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketOwnershipControls, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketReplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketReplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteBucketWebsite, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteBucketWebsite, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteObjectTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteObjectTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeleteObjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeleteObjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::DeletePublicAccessBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::DeletePublicAccessBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketAccelerateConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketAccelerateConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketAcl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketAcl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketAnalyticsConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketAnalyticsConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketCors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketCors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketEncryption, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketEncryption, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketIntelligentTieringConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketIntelligentTieringConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketInventoryConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketInventoryConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketLifecycleConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketLifecycleConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketLocation, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketLocation, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketLogging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketLogging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketMetricsConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketMetricsConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketNotificationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketNotificationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketOwnershipControls, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketOwnershipControls, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketPolicyStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketPolicyStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketReplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketReplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketRequestPayment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketRequestPayment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketVersioning, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketVersioning, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetBucketWebsite, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetBucketWebsite, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetObjectAcl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetObjectAcl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetObjectAttributes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetObjectAttributes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetObjectLegalHold, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetObjectLegalHold, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetObjectLockConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetObjectLockConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetObjectRetention, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetObjectRetention, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetObjectTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetObjectTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetObjectTorrent, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetObjectTorrent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::GetPublicAccessBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::GetPublicAccessBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::HeadBucket, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::HeadBucket, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::HeadObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::HeadObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::ListBucketAnalyticsConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::ListBucketAnalyticsConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::ListBucketIntelligentTieringConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::ListBucketIntelligentTieringConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::ListBucketInventoryConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::ListBucketInventoryConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::ListBucketMetricsConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::ListBucketMetricsConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::ListMultipartUploads, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::ListMultipartUploads, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::ListObjectVersions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::ListObjectVersions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::ListObjects, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::ListObjects, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::ListObjectsV2, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::ListObjectsV2, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::ListParts, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::ListParts, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketAccelerateConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketAccelerateConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketAcl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketAcl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketAnalyticsConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketAnalyticsConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketCors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketCors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketEncryption, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketEncryption, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketIntelligentTieringConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketIntelligentTieringConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketInventoryConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketInventoryConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketLifecycleConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketLifecycleConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketLogging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketLogging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketMetricsConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketMetricsConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketNotificationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketNotificationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketOwnershipControls, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketOwnershipControls, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketReplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketReplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketRequestPayment, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketRequestPayment, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketVersioning, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketVersioning, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutBucketWebsite, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutBucketWebsite, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutObjectAcl, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutObjectAcl, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutObjectLegalHold, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutObjectLegalHold, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutObjectLockConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutObjectLockConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutObjectRetention, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutObjectRetention, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutObjectTagging, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutObjectTagging, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::PutPublicAccessBlock, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::PutPublicAccessBlock, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::RestoreObject, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::RestoreObject, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableStreamingOperation(ALLOCATION_TAG, &S3Client::SelectObjectContent, this, request, m_executor.get());
}
...
{
  MakeAsyncStreamingOperation(&S3Client::SelectObjectContent, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::UploadPart, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::UploadPart, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::UploadPartCopy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::UploadPartCopy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &S3Client::WriteGetObjectResponse, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&S3Client::WriteGetObjectResponse, this, request, handler, context, m_executor.get());
}
