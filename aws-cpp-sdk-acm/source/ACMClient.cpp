...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::AddTagsToCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::AddTagsToCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::DeleteCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::DeleteCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::DescribeCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::DescribeCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::ExportCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::ExportCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::GetCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::GetCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::ImportCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::ImportCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::ListCertificates, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::ListCertificates, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::ListTagsForCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::ListTagsForCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::PutAccountConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::PutAccountConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::RemoveTagsFromCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::RemoveTagsFromCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::RenewCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::RenewCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::RequestCertificate, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::RequestCertificate, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::ResendValidationEmail, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::ResendValidationEmail, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ACMClient::UpdateCertificateOptions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ACMClient::UpdateCertificateOptions, this, request, handler, context, m_executor.get());
}
