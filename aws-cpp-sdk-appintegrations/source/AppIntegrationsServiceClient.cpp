...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::CreateDataIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::CreateDataIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::CreateEventIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::CreateEventIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::DeleteDataIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::DeleteDataIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::DeleteEventIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::DeleteEventIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::GetDataIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::GetDataIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::GetEventIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::GetEventIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::ListDataIntegrationAssociations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::ListDataIntegrationAssociations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::ListDataIntegrations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::ListDataIntegrations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::ListEventIntegrationAssociations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::ListEventIntegrationAssociations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::ListEventIntegrations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::ListEventIntegrations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::UpdateDataIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::UpdateDataIntegration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppIntegrationsServiceClient::UpdateEventIntegration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppIntegrationsServiceClient::UpdateEventIntegration, this, request, handler, context, m_executor.get());
}
