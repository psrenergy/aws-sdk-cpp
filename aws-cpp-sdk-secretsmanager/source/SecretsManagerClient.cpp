...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::CancelRotateSecret, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::CancelRotateSecret, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::CreateSecret, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::CreateSecret, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::DeleteResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::DeleteResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::DeleteSecret, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::DeleteSecret, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::DescribeSecret, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::DescribeSecret, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::GetRandomPassword, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::GetRandomPassword, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::GetResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::GetResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::GetSecretValue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::GetSecretValue, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::ListSecretVersionIds, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::ListSecretVersionIds, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::ListSecrets, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::ListSecrets, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::PutResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::PutResourcePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::PutSecretValue, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::PutSecretValue, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::RemoveRegionsFromReplication, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::RemoveRegionsFromReplication, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::ReplicateSecretToRegions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::ReplicateSecretToRegions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::RestoreSecret, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::RestoreSecret, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::RotateSecret, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::RotateSecret, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::StopReplicationToReplica, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::StopReplicationToReplica, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::UpdateSecret, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::UpdateSecret, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::UpdateSecretVersionStage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::UpdateSecretVersionStage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SecretsManagerClient::ValidateResourcePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SecretsManagerClient::ValidateResourcePolicy, this, request, handler, context, m_executor.get());
}
