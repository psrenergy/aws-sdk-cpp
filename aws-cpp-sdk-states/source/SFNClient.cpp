...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::CreateActivity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::CreateActivity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::CreateStateMachine, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::CreateStateMachine, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::DeleteActivity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::DeleteActivity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::DeleteStateMachine, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::DeleteStateMachine, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::DescribeActivity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::DescribeActivity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::DescribeExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::DescribeExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::DescribeStateMachine, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::DescribeStateMachine, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::DescribeStateMachineForExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::DescribeStateMachineForExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::GetActivityTask, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::GetActivityTask, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::GetExecutionHistory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::GetExecutionHistory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::ListActivities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::ListActivities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::ListExecutions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::ListExecutions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::ListStateMachines, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::ListStateMachines, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::SendTaskFailure, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::SendTaskFailure, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::SendTaskHeartbeat, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::SendTaskHeartbeat, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::SendTaskSuccess, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::SendTaskSuccess, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::StartExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::StartExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::StartSyncExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::StartSyncExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::StopExecution, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::StopExecution, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &SFNClient::UpdateStateMachine, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&SFNClient::UpdateStateMachine, this, request, handler, context, m_executor.get());
}
