...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::AssociateTrackerConsumer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::AssociateTrackerConsumer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::BatchDeleteDevicePositionHistory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::BatchDeleteDevicePositionHistory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::BatchDeleteGeofence, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::BatchDeleteGeofence, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::BatchEvaluateGeofences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::BatchEvaluateGeofences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::BatchGetDevicePosition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::BatchGetDevicePosition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::BatchPutGeofence, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::BatchPutGeofence, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::BatchUpdateDevicePosition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::BatchUpdateDevicePosition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::CalculateRoute, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::CalculateRoute, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::CalculateRouteMatrix, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::CalculateRouteMatrix, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::CreateGeofenceCollection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::CreateGeofenceCollection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::CreateMap, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::CreateMap, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::CreatePlaceIndex, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::CreatePlaceIndex, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::CreateRouteCalculator, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::CreateRouteCalculator, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::CreateTracker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::CreateTracker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DeleteGeofenceCollection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DeleteGeofenceCollection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DeleteMap, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DeleteMap, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DeletePlaceIndex, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DeletePlaceIndex, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DeleteRouteCalculator, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DeleteRouteCalculator, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DeleteTracker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DeleteTracker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DescribeGeofenceCollection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DescribeGeofenceCollection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DescribeMap, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DescribeMap, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DescribePlaceIndex, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DescribePlaceIndex, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DescribeRouteCalculator, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DescribeRouteCalculator, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DescribeTracker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DescribeTracker, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::DisassociateTrackerConsumer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::DisassociateTrackerConsumer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::GetDevicePosition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::GetDevicePosition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::GetDevicePositionHistory, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::GetDevicePositionHistory, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::GetGeofence, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::GetGeofence, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::GetMapGlyphs, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::GetMapGlyphs, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::GetMapSprites, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::GetMapSprites, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::GetMapStyleDescriptor, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::GetMapStyleDescriptor, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::GetMapTile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::GetMapTile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::GetPlace, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::GetPlace, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::ListDevicePositions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::ListDevicePositions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::ListGeofenceCollections, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::ListGeofenceCollections, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::ListGeofences, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::ListGeofences, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::ListMaps, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::ListMaps, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::ListPlaceIndexes, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::ListPlaceIndexes, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::ListRouteCalculators, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::ListRouteCalculators, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::ListTrackerConsumers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::ListTrackerConsumers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::ListTrackers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::ListTrackers, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::PutGeofence, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::PutGeofence, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::SearchPlaceIndexForPosition, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::SearchPlaceIndexForPosition, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::SearchPlaceIndexForSuggestions, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::SearchPlaceIndexForSuggestions, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::SearchPlaceIndexForText, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::SearchPlaceIndexForText, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::UpdateGeofenceCollection, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::UpdateGeofenceCollection, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::UpdateMap, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::UpdateMap, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::UpdatePlaceIndex, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::UpdatePlaceIndex, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::UpdateRouteCalculator, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::UpdateRouteCalculator, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &LocationServiceClient::UpdateTracker, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&LocationServiceClient::UpdateTracker, this, request, handler, context, m_executor.get());
}
