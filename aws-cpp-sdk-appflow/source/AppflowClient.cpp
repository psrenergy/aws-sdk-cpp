...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::CreateConnectorProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::CreateConnectorProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::CreateFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::CreateFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::DeleteConnectorProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::DeleteConnectorProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::DeleteFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::DeleteFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::DescribeConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::DescribeConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::DescribeConnectorEntity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::DescribeConnectorEntity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::DescribeConnectorProfiles, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::DescribeConnectorProfiles, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::DescribeConnectors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::DescribeConnectors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::DescribeFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::DescribeFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::DescribeFlowExecutionRecords, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::DescribeFlowExecutionRecords, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::ListConnectorEntities, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::ListConnectorEntities, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::ListConnectors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::ListConnectors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::ListFlows, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::ListFlows, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::RegisterConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::RegisterConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::StartFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::StartFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::StopFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::StopFlow, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::UnregisterConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::UnregisterConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::UpdateConnectorProfile, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::UpdateConnectorProfile, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &AppflowClient::UpdateFlow, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&AppflowClient::UpdateFlow, this, request, handler, context, m_executor.get());
}
