...
{
  return MakeCallableOperation(ALLOCATION_TAG, &STSClient::AssumeRole, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&STSClient::AssumeRole, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &STSClient::AssumeRoleWithSAML, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&STSClient::AssumeRoleWithSAML, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &STSClient::AssumeRoleWithWebIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&STSClient::AssumeRoleWithWebIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &STSClient::DecodeAuthorizationMessage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&STSClient::DecodeAuthorizationMessage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &STSClient::GetAccessKeyInfo, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&STSClient::GetAccessKeyInfo, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &STSClient::GetCallerIdentity, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&STSClient::GetCallerIdentity, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &STSClient::GetFederationToken, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&STSClient::GetFederationToken, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &STSClient::GetSessionToken, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&STSClient::GetSessionToken, this, request, handler, context, m_executor.get());
}
