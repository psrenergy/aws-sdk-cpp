...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::BatchCheckLayerAvailability, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::BatchCheckLayerAvailability, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::BatchDeleteImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::BatchDeleteImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::BatchGetImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::BatchGetImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::BatchGetRepositoryScanningConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::BatchGetRepositoryScanningConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::CompleteLayerUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::CompleteLayerUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::CreatePullThroughCacheRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::CreatePullThroughCacheRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::CreateRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::CreateRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DeleteLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DeleteLifecyclePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DeletePullThroughCacheRule, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DeletePullThroughCacheRule, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DeleteRegistryPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DeleteRegistryPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DeleteRepository, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DeleteRepository, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DeleteRepositoryPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DeleteRepositoryPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DescribeImageReplicationStatus, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DescribeImageReplicationStatus, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DescribeImageScanFindings, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DescribeImageScanFindings, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DescribeImages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DescribeImages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DescribePullThroughCacheRules, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DescribePullThroughCacheRules, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DescribeRegistry, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DescribeRegistry, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::DescribeRepositories, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::DescribeRepositories, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::GetAuthorizationToken, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::GetAuthorizationToken, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::GetDownloadUrlForLayer, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::GetDownloadUrlForLayer, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::GetLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::GetLifecyclePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::GetLifecyclePolicyPreview, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::GetLifecyclePolicyPreview, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::GetRegistryPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::GetRegistryPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::GetRegistryScanningConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::GetRegistryScanningConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::GetRepositoryPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::GetRepositoryPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::InitiateLayerUpload, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::InitiateLayerUpload, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::ListImages, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::ListImages, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::ListTagsForResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::ListTagsForResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::PutImage, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::PutImage, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::PutImageScanningConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::PutImageScanningConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::PutImageTagMutability, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::PutImageTagMutability, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::PutLifecyclePolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::PutLifecyclePolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::PutRegistryPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::PutRegistryPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::PutRegistryScanningConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::PutRegistryScanningConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::PutReplicationConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::PutReplicationConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::SetRepositoryPolicy, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::SetRepositoryPolicy, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::StartImageScan, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::StartImageScan, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::StartLifecyclePolicyPreview, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::StartLifecyclePolicyPreview, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::TagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::TagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::UntagResource, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::UntagResource, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &ECRClient::UploadLayerPart, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&ECRClient::UploadLayerPart, this, request, handler, context, m_executor.get());
}
