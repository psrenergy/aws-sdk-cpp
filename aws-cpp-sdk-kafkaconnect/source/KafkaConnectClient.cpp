...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::CreateConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::CreateConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::CreateCustomPlugin, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::CreateCustomPlugin, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::CreateWorkerConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::CreateWorkerConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::DeleteConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::DeleteConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::DeleteCustomPlugin, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::DeleteCustomPlugin, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::DescribeConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::DescribeConnector, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::DescribeCustomPlugin, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::DescribeCustomPlugin, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::DescribeWorkerConfiguration, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::DescribeWorkerConfiguration, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::ListConnectors, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::ListConnectors, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::ListCustomPlugins, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::ListCustomPlugins, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::ListWorkerConfigurations, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::ListWorkerConfigurations, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &KafkaConnectClient::UpdateConnector, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&KafkaConnectClient::UpdateConnector, this, request, handler, context, m_executor.get());
}
