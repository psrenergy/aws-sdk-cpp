...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PersonalizeEventsClient::PutEvents, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PersonalizeEventsClient::PutEvents, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PersonalizeEventsClient::PutItems, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PersonalizeEventsClient::PutItems, this, request, handler, context, m_executor.get());
}
...
{
  return MakeCallableOperation(ALLOCATION_TAG, &PersonalizeEventsClient::PutUsers, this, request, m_executor.get());
}
...
{
  MakeAsyncOperation(&PersonalizeEventsClient::PutUsers, this, request, handler, context, m_executor.get());
}
